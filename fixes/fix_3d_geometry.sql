-- Moving from 2d to 3d geometry in LV95=2056 (av03=21781)
...
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN detail_geometry3d_geometry geometry(CurvePolygonZ,2056);
...
ALTER TABLE qgep.od_reach ADD COLUMN progression3d_geometry geometry(CompoundCurveZ,2056);
