...
ADD COLUMN situation3d_geometry geometry(PointZ, :SRID);
...
ADD COLUMN perimeter3d_geometry geometry(CurvePolygonZ, :SRID);
...
--od_building
ALTER TABLE qgep.od_building
ADD COLUMN reference_point3d_geometry geometry(PointZ, :SRID);
...
ADD COLUMN textpos3d_geometry geometry(PointZ, :SRID);
...
ADD COLUMN progression3d_geometry geometry(CompoundCurveZ, :SRID);
...
ADD COLUMN symbolpos3d_geometry geometry(PointZ, :SRID);
...
ADD COLUMN from_geometry3d geometry(PointZ, :SRID);
...
--od_water_course_segment
ALTER TABLE qgep.od_water_course_segment
ADD COLUMN to_geometry3d geometry(PointZ, :SRID);
