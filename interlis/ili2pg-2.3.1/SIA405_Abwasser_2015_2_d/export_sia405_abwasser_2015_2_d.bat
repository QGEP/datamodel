...
java -jar ili2pg.jar --trace --export --log ex_ab3.log --models SIA405_Abwasser_2015 --dbhost localhost --dbport 5432 --dbdatabase qgep --dbschema sia405abwasser --dbusr postgres --dbpwd post$gres export_arbon_small_sia405abwasser_2015_d.xtf
