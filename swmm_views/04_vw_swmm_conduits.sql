		...
		WHEN pppt.vsacode = 3354 THEN 
			CASE
				...
				WHEN pp.height_width_ratio IS NULL THEN 
					...
					END
			END
		WHEN pppt.vsacode = 3355 THEN concat('Reach', re.obj_id,': custom profile to be defined in SWMM')
	END,
	CASE
