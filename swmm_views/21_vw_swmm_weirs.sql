...
AND (oc.overflow_char_digital != 6223 OR oc.overflow_char_digital IS NULL) --'yes;
OR (oc.kind_overflow_char != 6220 OR oc.overflow_char_digital IS NULL)-- h/q relations (Q/Q relations are not supported by SWMM) 
