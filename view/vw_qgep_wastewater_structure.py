...
def vw_qgep_wastewater_structure(srid: int, pg_service: str = None, extra_definition: dict = None):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-e", "--extra-definition", help="YAML file path for extra additions to the view"
    )
