CREATE OR REPLACE VIEW qgep_sigip.vw_export_reach_to AS
  SELECT
  ...
  FULL JOIN qgep_od.vw_qgep_reach re on re.rp_to_fk_wastewater_networkelement = ws.wn_obj_id
  ...
  WHERE re.rp_to_fk_wastewater_networkelement is not null
