CREATE VIEW qgep.vw_change_points AS
SELECT
  rp_to.obj_id,
...
LEFT JOIN qgep.od_reach re_next ON rp_to.fk_wastewater_networkelement = re_next.obj_id
LEFT JOIN qgep.od_reach_point rp_next_to ON rp_next_to.obj_id = re_next.fk_reach_point_to
LEFT JOIN qgep.od_reach_point rp_next_from ON rp_next_from.obj_id = re_next.fk_reach_point_from
LEFT JOIN qgep.od_wastewater_networkelement ne ON re.obj_id = ne.obj_id
LEFT JOIN qgep.od_wastewater_networkelement ne_next ON re_next.obj_id = ne_next.obj_id
