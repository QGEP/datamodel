...
def create_views(
    ...
    SingleInheritance(
        ...
        view_name="vw_electric_equipment",
        pg_service=pg_service,
        pkey_default_value=True,
        inner_defaults={"identifier": "obj_id"},
    ).create()
    SingleInheritance(
        ...
        view_name="vw_electromechanical_equipment",
        pg_service=pg_service,
        pkey_default_value=True,
        inner_defaults={"identifier": "obj_id"},
    ).create()
    ...
    MultipleInheritance(
        safe_load(open("view/vw_maintenance_examination.yaml")), drop=True, pg_service=pg_service
    ).create()
    MultipleInheritance(
        safe_load(open("view/vw_damage.yaml")), drop=True, pg_service=pg_service
    ).create()

    vw_qgep_wastewater_structure(
        srid, pg_service=pg_service, extra_definition=qgep_wastewater_structure_extra
    )
    ...
    MultipleInheritance(
        safe_load(open("view/vw_oo_overflow.yaml")),
        create_joins=True,
        variables=variables,
        pg_service=pg_service,
        drop=True,
    ...
    MultipleInheritance(
        safe_load(open("view/vw_oo_organisation.yaml")), drop=True, pg_service=pg_service
    ).create()
    ...
    SimpleJoins(
        safe_load(open("view/export/vw_export_wastewater_structure.yaml")), pg_service
    ).create()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--qgep_wastewater_structure_extra",
        help="YAML definition file path for additions to vw_qgep_wastewater_structure view",
    )
    parser.add_argument(
        "--qgep_reach_extra", help="YAML definition file path for additions to vw_qgep_reach view"
    )
