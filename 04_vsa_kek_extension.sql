...
FOR EACH ROW EXECUTE PROCEDURE
 qgep.update_last_modified_parent("qgep.od_maintenance_event");
...
COMMENT ON COLUMN qgep.od_damage.single_damage_class IS 'yyy_Definiert die Schadensklasse eines Einzelschadens. Die Einteilung in die Zustandsklassen erfolgt aufgrund des Schadenbilds und des Schadensausmasses. Dabei kann ein Abwasserbauwerk direkt einer Klasse zugeteilt werden oder zuerst jeder Schaden einzeln klassifiziert werden. (Am Schluss bestimmt dann z.B. der schwerste Einzelschaden die Klassifizierung des gesamten Kanals (Abwasserbauwerk.BaulicherZustand)). / Definiert die Schadensklasse eines Einzelschadens. Die Einteilung in die Zustandsklassen erfolgt aufgrund des Schadenbilds und des Schadensausmasses. Dabei kann ein Abwasserbauwerk direkt einer Klasse zugeteilt werden oder zuerst jeder Schaden einzeln klassifiziert werden. (Am Schluss bestimmt dann z.B. der schwerste Einzelschaden die Klassifizierung des gesamten Kanals (Abwasserbauwerk.BaulicherZustand)). / Définit la classe de dommages d’un dommage unique. La répartition en classes d’état s’effectue sur la base de la nature et de l’étendue des dommages. Un ouvrage d''assainissement peut être classé directement ou chaque dommage peut d’abord être classé sépar';
 ALTER TABLE qgep.od_damage ADD COLUMN video_counter  varchar(11) ;
COMMENT ON COLUMN qgep.od_damage.video_counter IS 'yyy_Zählerstand auf einem analogen Videoband oder in einer digitalen Videodatei, in Echtzeit / Zählerstand auf einem analogen Videoband oder in einer digitalen Videodatei, in Echtzeit';
 ALTER TABLE qgep.od_damage ADD COLUMN view_parameters  varchar(200) ;
...
FOR EACH ROW EXECUTE PROCEDURE
 qgep.update_last_modified_parent("qgep.od_damage");
...
COMMENT ON COLUMN qgep.od_damage_manhole.obj_id IS 'INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
 ALTER TABLE qgep.od_damage_manhole ADD COLUMN manhole_damage_code  integer ;
COMMENT ON COLUMN qgep.od_damage_manhole.manhole_damage_code IS 'yyy_Vorgegebener Wertebereich: Gültiger Code auf der Grundlage von SN EN 13508-2. Alle gültigen Codes sind in Kapitel 3 der Richtlinie "Schadencodierung" abschliessend aufgeführt. / Vorgegebener Wertebereich: Gültiger Code auf der Grundlage von SN EN 13508-2. Alle gültigen Codes sind in Kapitel 3 der Richtlinie "Schadencodierung" abschliessend aufgeführt. / Domaine de valeur prédéfini: Code valide sur la base de la SN EN 13508-2. Tous les codes valides sont mentionnés dans le chapitre 3 de la directive.';
...
ALTER TABLE qgep.od_file ADD CONSTRAINT rel_file_volume FOREIGN KEY (fk_volume) REFERENCES qgep.od_data_media(obj_id) ON DELETE set null;
ALTER TABLE qgep.od_examination ADD CONSTRAINT oorel_od_examination_maintenance_event FOREIGN KEY (obj_id) REFERENCES qgep.od_maintenance_event(obj_id) ON DELETE cascade;
...
ALTER TABLE qgep.od_examination ADD CONSTRAINT rel_examination_reach_point FOREIGN KEY (fk_reach_point) REFERENCES qgep.od_reach_point(obj_id) ON DELETE set null;
...
ALTER TABLE qgep.vl_damage_connection ADD CONSTRAINT pkey_qgep_vl_damage_connection_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_damage_connection (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (8498,8498,'yes','ja','oui', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_connection (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (8499,8499,'no','nein','non', '', '', '', 'true');
 ALTER TABLE qgep.od_damage ADD CONSTRAINT fkey_vl_damage_connection FOREIGN KEY (connection)
 REFERENCES qgep.vl_damage_connection (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE qgep.od_damage ADD CONSTRAINT rel_damage_examination FOREIGN KEY (fk_examination) REFERENCES qgep.od_examination(obj_id) ON DELETE cascade;
ALTER TABLE qgep.od_damage_channel ADD CONSTRAINT oorel_od_damage_channel_damage FOREIGN KEY (obj_id) REFERENCES qgep.od_damage(obj_id) ON DELETE cascade;
...
ALTER TABLE qgep.vl_damage_channel_channel_damage_code ADD CONSTRAINT pkey_qgep_vl_damage_channel_channel_damage_code_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_damage_manhole ADD CONSTRAINT oorel_od_damage_manhole_damage FOREIGN KEY (obj_id) REFERENCES qgep.od_damage(obj_id) ON DELETE cascade;
CREATE TABLE qgep.vl_damage_manhole_manhole_damage_code () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_damage_manhole_manhole_damage_code ADD CONSTRAINT pkey_qgep_vl_damage_manhole_manhole_damage_code_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4148,4148,'DAAA','DAAA','DAAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4149,4149,'DAAB','DAAB','DAAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4150,4150,'DABAA','DABAA','DABAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4151,4151,'DABAB','DABAB','DABAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4152,4152,'DABAC','DABAC','DABAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4153,4153,'DABAD','DABAD','DABAD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4154,4154,'DABBA','DABBA','DABBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4155,4155,'DABBB','DABBB','DABBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4156,4156,'DABBC','DABBC','DABBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4157,4157,'DABBD','DABBD','DABBD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4158,4158,'DABCA','DABCA','DABCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4159,4159,'DABCB','DABCB','DABCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4160,4160,'DABCC','DABCC','DABCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4161,4161,'DABCD','DABCD','DABCD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4162,4162,'DACA','DACA','DACA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4163,4163,'DACB','DACB','DACB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4164,4164,'DACC','DACC','DACC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4165,4165,'DADA','DADA','DADA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4166,4166,'DADB','DADB','DADB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4167,4167,'DADC','DADC','DADC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4168,4168,'DAE','DAE','DAE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4169,4169,'DAFAA','DAFAA','DAFAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4170,4170,'DAFAB','DAFAB','DAFAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4171,4171,'DAFAC','DAFAC','DAFAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4172,4172,'DAFAD','DAFAD','DAFAD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4173,4173,'DAFAE','DAFAE','DAFAE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4174,4174,'DAFBA','DAFBA','DAFBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4175,4175,'DAFBE','DAFBE','DAFBE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4176,4176,'DAFCA','DAFCA','DAFCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4177,4177,'DAFCB','DAFCB','DAFCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4178,4178,'DAFCC','DAFCC','DAFCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4179,4179,'DAFCD','DAFCD','DAFCD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4180,4180,'DAFCE','DAFCE','DAFCE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4181,4181,'DAFDA','DAFDA','DAFDA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4182,4182,'DAFDB','DAFDB','DAFDB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4183,4183,'DAFDC','DAFDC','DAFDC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4184,4184,'DAFDD','DAFDD','DAFDD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4185,4185,'DAFDE','DAFDE','DAFDE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4186,4186,'DAFEA','DAFEA','DAFEA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4187,4187,'DAFEB','DAFEB','DAFEB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4188,4188,'DAFEC','DAFEC','DAFEC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4189,4189,'DAFED','DAFED','DAFED', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4190,4190,'DAFEE','DAFEE','DAFEE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4191,4191,'DAFFA','DAFFA','DAFFA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4192,4192,'DAFFB','DAFFB','DAFFB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4193,4193,'DAFFC','DAFFC','DAFFC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4194,4194,'DAFFD','DAFFD','DAFFD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4195,4195,'DAFFE','DAFFE','DAFFE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4196,4196,'DAFGA','DAFGA','DAFGA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4197,4197,'DAFGB','DAFGB','DAFGB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4198,4198,'DAFGC','DAFGC','DAFGC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4199,4199,'DAFGD','DAFGD','DAFGD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4200,4200,'DAFGE','DAFGE','DAFGE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4201,4201,'DAFHB','DAFHB','DAFHB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4202,4202,'DAFHC','DAFHC','DAFHC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4203,4203,'DAFHD','DAFHD','DAFHD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4204,4204,'DAFHE','DAFHE','DAFHE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4205,4205,'DAFIA','DAFIA','DAFIA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4206,4206,'DAFIB','DAFIB','DAFIB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4207,4207,'DAFIC','DAFIC','DAFIC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4208,4208,'DAFID','DAFID','DAFID', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4209,4209,'DAFIE','DAFIE','DAFIE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4210,4210,'DAFJB','DAFJB','DAFJB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4211,4211,'DAFJC','DAFJC','DAFJC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4212,4212,'DAFJD','DAFJD','DAFJD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4213,4213,'DAFJE','DAFJE','DAFJE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4214,4214,'DAFZA','DAFZA','DAFZA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4215,4215,'DAFZB','DAFZB','DAFZB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4216,4216,'DAFZC','DAFZC','DAFZC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4217,4217,'DAFZD','DAFZD','DAFZD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4218,4218,'DAFZE','DAFZE','DAFZE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4219,4219,'DAG','DAG','DAG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4220,4220,'DAHA','DAHA','DAHA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4221,4221,'DAHB','DAHB','DAHB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4222,4222,'DAHC','DAHC','DAHC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4223,4223,'DAHD','DAHD','DAHD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4224,4224,'DAHE','DAHE','DAHE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4225,4225,'DAHZ','DAHZ','DAHZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4226,4226,'DAIAA','DAIAA','DAIAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4227,4227,'DAIAB','DAIAB','DAIAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4228,4228,'DAIAC','DAIAC','DAIAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4229,4229,'DAIZ','DAIZ','DAIZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4230,4230,'DAJA','DAJA','DAJA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4231,4231,'DAJB','DAJB','DAJB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4232,4232,'DAJC','DAJC','DAJC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4233,4233,'DAKA','DAKA','DAKA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4234,4234,'DAKB','DAKB','DAKB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4235,4235,'DAKC','DAKC','DAKC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4236,4236,'DAKDA','DAKDA','DAKDA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4237,4237,'DAKDB','DAKDB','DAKDB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4238,4238,'DAKDC','DAKDC','DAKDC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4239,4239,'DAKE','DAKE','DAKE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4240,4240,'DAKZ','DAKZ','DAKZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4241,4241,'DALA','DALA','DALA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4242,4242,'DALB','DALB','DALB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4243,4243,'DALZ','DALZ','DALZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4244,4244,'DAMA','DAMA','DAMA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4245,4245,'DAMB','DAMB','DAMB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4246,4246,'DAMC','DAMC','DAMC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4247,4247,'DAN','DAN','DAN', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4248,4248,'DAO','DAO','DAO', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4249,4249,'DAP','DAP','DAP', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4250,4250,'DAQA','DAQA','DAQA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4251,4251,'DAQB','DAQB','DAQB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4252,4252,'DAQC','DAQC','DAQC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4253,4253,'DAQD','DAQD','DAQD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4254,4254,'DAQE','DAQE','DAQE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4255,4255,'DAQF','DAQF','DAQF', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4256,4256,'DAQG','DAQG','DAQG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4257,4257,'DAQH','DAQH','DAQH', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4258,4258,'DAQI','DAQI','DAQI', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4259,4259,'DAQJ','DAQJ','DAQJ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4260,4260,'DAQK','DAQK','DAQK', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4261,4261,'DAQZ','DAQZ','DAQZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4262,4262,'DARA','DARA','DARA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4263,4263,'DARB','DARB','DARB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4264,4264,'DARC','DARC','DARC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4265,4265,'DARD','DARD','DARD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4266,4266,'DARE','DARE','DARE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4267,4267,'DARF','DARF','DARF', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4268,4268,'DARG','DARG','DARG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4269,4269,'DARH','DARH','DARH', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4270,4270,'DARZ','DARZ','DARZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4271,4271,'DBAA','DBAA','DBAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4272,4272,'DBAB','DBAB','DBAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4273,4273,'DBAC','DBAC','DBAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4274,4274,'DBBA','DBBA','DBBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4275,4275,'DBBB','DBBB','DBBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4276,4276,'DBBC','DBBC','DBBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4277,4277,'DBBZ','DBBZ','DBBZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4278,4278,'DBCA','DBCA','DBCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4279,4279,'DBCB','DBCB','DBCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4280,4280,'DBCC','DBCC','DBCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4281,4281,'DBCZ','DBCZ','DBCZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4282,4282,'DBD','DBD','DBD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4283,4283,'DBEA','DBEA','DBEA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4284,4284,'DBEB','DBEB','DBEB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4285,4285,'DBEC','DBEC','DBEC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4286,4286,'DBED','DBED','DBED', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4287,4287,'DBEE','DBEE','DBEE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4288,4288,'DBEF','DBEF','DBEF', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4289,4289,'DBEG','DBEG','DBEG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4290,4290,'DBEH','DBEH','DBEH', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4291,4291,'DBEZ','DBEZ','DBEZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4292,4292,'DBFAA','DBFAA','DBFAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4293,4293,'DBFAB','DBFAB','DBFAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4294,4294,'DBFAC','DBFAC','DBFAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4295,4295,'DBFBA','DBFBA','DBFBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4296,4296,'DBFBB','DBFBB','DBFBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4297,4297,'DBFBC','DBFBC','DBFBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4298,4298,'DBFCA','DBFCA','DBFCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4299,4299,'DBFCB','DBFCB','DBFCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4300,4300,'DBFCC','DBFCC','DBFCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4301,4301,'DBFDA','DBFDA','DBFDA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4302,4302,'DBFDB','DBFDB','DBFDB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4303,4303,'DBFDC','DBFDC','DBFDC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4304,4304,'DBG','DBG','DBG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4305,4305,'DBHAA','DBHAA','DBHAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4306,4306,'DBHAB','DBHAB','DBHAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4307,4307,'DBHAC','DBHAC','DBHAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4308,4308,'DBHAZ','DBHAZ','DBHAZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4309,4309,'DBHBA','DBHBA','DBHBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4310,4310,'DBHBB','DBHBB','DBHBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4311,4311,'DBHBC','DBHBC','DBHBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4312,4312,'DBHBZ','DBHBZ','DBHBZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4313,4313,'DBHZA','DBHZA','DBHZA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4314,4314,'DBHZB','DBHZB','DBHZB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4315,4315,'DBHZC','DBHZC','DBHZC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4316,4316,'DBHZZ','DBHZZ','DBHZZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4317,4317,'DCAA','DCAA','DCAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4318,4318,'DCAB','DCAB','DCAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4319,4319,'DCAC','DCAC','DCAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4320,4320,'DCAD','DCAD','DCAD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4321,4321,'DCAE','DCAE','DCAE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4322,4322,'DCAF','DCAF','DCAF', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4323,4323,'DCAZ','DCAZ','DCAZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4324,4324,'DCBA','DCBA','DCBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4325,4325,'DCBB','DCBB','DCBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4326,4326,'DCBC','DCBC','DCBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4327,4327,'DCBZ','DCBZ','DCBZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4328,4328,'DCFA','DCFA','DCFA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4329,4329,'DCFB','DCFB','DCFB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4330,4330,'DCFC','DCFC','DCFC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4331,4331,'DCFD','DCFD','DCFD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4332,4332,'DCFE','DCFE','DCFE', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4333,4333,'DCFF','DCFF','DCFF', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4334,4334,'DCFG','DCFG','DCFG', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4335,4335,'DCFH','DCFH','DCFH', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4336,4336,'DCFI','DCFI','DCFI', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4337,4337,'DCFJ','DCFJ','DCFJ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4338,4338,'DCFK','DCFK','DCFK', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4339,4339,'DCFL','DCFL','DCFL', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4340,4340,'DCFM','DCFM','DCFM', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4341,4341,'DCFN','DCFN','DCFN', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4342,4342,'DCFO','DCFO','DCFO', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4343,4343,'DCFP','DCFP','DCFP', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4344,4344,'DCFQ','DCFQ','DCFQ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4345,4345,'DCFR','DCFR','DCFR', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4346,4346,'DCFS','DCFS','DCFS', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4347,4347,'DCFT','DCFT','DCFT', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4348,4348,'DCFU','DCFU','DCFU', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4349,4349,'DCFV','DCFV','DCFV', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4350,4350,'DCFW','DCFW','DCFW', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4351,4351,'DCFX','DCFX','DCFX', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4352,4352,'DCGAA','DCGAA','DCGAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4353,4353,'DCGAB','DCGAB','DCGAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4354,4354,'DCGAC','DCGAC','DCGAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4355,4355,'DCGBA','DCGBA','DCGBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4356,4356,'DCGBB','DCGBB','DCGBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4357,4357,'DCGBC','DCGBC','DCGBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4358,4358,'DCGCA','DCGCA','DCGCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4359,4359,'DCGCB','DCGCB','DCGCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4360,4360,'DCGCC','DCGCC','DCGCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4361,4361,'DCGXA','DCGXA','DCGXA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4364,4364,'DCGXAA','DCGXAA','DCGXAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4365,4365,'DCGXAB','DCGXAB','DCGXAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4366,4366,'DCGXAC','DCGXAC','DCGXAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4362,4362,'DCGXB','DCGXB','DCGXB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4367,4367,'DCGXBA','DCGXBA','DCGXBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4368,4368,'DCGXBB','DCGXBB','DCGXBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4369,4369,'DCGXBC','DCGXBC','DCGXBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4363,4363,'DCGXC','DCGXC','DCGXC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4370,4370,'DCGXCA','DCGXCA','DCGXCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4371,4371,'DCGXCB','DCGXCB','DCGXCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4372,4372,'DCGXCC','DCGXCC','DCGXCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4373,4373,'DCGYA','DCGYA','DCGYA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4374,4374,'DCGYB','DCGYB','DCGYB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4375,4375,'DCGYC','DCGYC','DCGYC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4376,4376,'DCGZA','DCGZA','DCGZA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4377,4377,'DCGZB','DCGZB','DCGZB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4378,4378,'DCGZC','DCGZC','DCGZC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4379,4379,'DCHA','DCHA','DCHA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4380,4380,'DCHAA','DCHAA','DCHAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4381,4381,'DCHAB','DCHAB','DCHAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4382,4382,'DCHB','DCHB','DCHB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4383,4383,'DCIA','DCIA','DCIA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4384,4384,'DCIB','DCIB','DCIB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4385,4385,'DCLAA','DCLAA','DCLAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4386,4386,'DCLAB','DCLAB','DCLAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4387,4387,'DCLBA','DCLBA','DCLBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4388,4388,'DCLBB','DCLBB','DCLBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4389,4389,'DCLCA','DCLCA','DCLCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4390,4390,'DCLCB','DCLCB','DCLCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4391,4391,'DCMA','DCMA','DCMA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4392,4392,'DCMB','DCMB','DCMB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4393,4393,'DCMC','DCMC','DCMC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4394,4394,'DDA','DDA','DDA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4395,4395,'DDB','DDB','DDB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4396,4396,'DDCA','DDCA','DDCA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4397,4397,'DDCB','DDCB','DDCB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4398,4398,'DDCC','DDCC','DDCC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4399,4399,'DDCD','DDCD','DDCD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4400,4400,'DDCZ','DDCZ','DDCZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4401,4401,'DDD','DDD','DDD', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4402,4402,'DDEAA','DDEAA','DDEAA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4403,4403,'DDEAB','DDEAB','DDEAB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4404,4404,'DDEAC','DDEAC','DDEAC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4405,4405,'DDEBA','DDEBA','DDEBA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4406,4406,'DDEBB','DDEBB','DDEBB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4407,4407,'DDEBC','DDEBC','DDEBC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4408,4408,'DDEYA','DDEYA','DDEYA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4409,4409,'DDEYB','DDEYB','DDEYB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4410,4410,'DDEYY','DDEYY','DDEYY', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4411,4411,'DDFA','DDFA','DDFA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4412,4412,'DDFB','DDFB','DDFB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4413,4413,'DDFC','DDFC','DDFC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4414,4414,'DDFZ','DDFZ','DDFZ', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4416,4416,'DDGA','DDGA','DDGA', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4417,4417,'DDGB','DDGB','DDGB', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4418,4418,'DDGC','DDGC','DDGC', '', '', '', 'true');
 INSERT INTO qgep.vl_damage_manhole_manhole_damage_code (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4419,4419,'DDGZ','DDGZ','DDGZ', '', '', '', 'true');
 ALTER TABLE qgep.od_damage_manhole ADD CONSTRAINT fkey_vl_damage_manhole_manhole_damage_code FOREIGN KEY (manhole_damage_code)
 REFERENCES qgep.vl_damage_manhole_manhole_damage_code (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE qgep.vl_file_class ADD CONSTRAINT pkey_qgep_vl_file_class_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_file_class (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (3858,3858,'standard_manhole','Normschacht','CHAMBRE_STANDARD', '', '', '', 'true');
