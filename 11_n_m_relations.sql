...
CREATE INDEX in_re_me_ws__fk_ws ON qgep.re_maintenance_event_wastewater_structure USING btree (fk_wastewater_structure ASC);
CREATE INDEX in_re_me_ws__fk_me ON qgep.re_maintenance_event_wastewater_structure USING btree (fk_maintenance_event ASC);
