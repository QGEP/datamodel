...
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN detail_geometry_geometry geometry('CURVEPOLYGON', :SRID);
...
ALTER TABLE qgep.od_reach ADD COLUMN progression_geometry geometry('COMPOUNDCURVE', :SRID);
...
COMMENT ON COLUMN qgep.od_overflow_characteristic.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
 ALTER TABLE qgep.od_overflow_characteristic ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_overflow_characteristic.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_hydraulic_characteristic_data.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
...
COMMENT ON COLUMN qgep.od_hydraulic_characteristic_data.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
 ALTER TABLE qgep.od_hydraulic_characteristic_data ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hydraulic_characteristic_data.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
ALTER TABLE qgep.od_municipality ADD CONSTRAINT oorel_od_municipality_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_administrative_office ADD CONSTRAINT oorel_od_administrative_office_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_waste_water_treatment_plant ADD CONSTRAINT oorel_od_waste_water_treatment_plant_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_private ADD CONSTRAINT oorel_od_private_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.od_river ADD CONSTRAINT oorel_od_river_surface_water_bodies FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_water_bodies(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_river_kind ADD CONSTRAINT pkey_qgep_vl_river_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_lake ADD CONSTRAINT oorel_od_lake_surface_water_bodies FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_water_bodies(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.od_channel ADD CONSTRAINT oorel_od_channel_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_channel_usage_planned ADD CONSTRAINT pkey_qgep_vl_channel_usage_planned_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_manhole ADD CONSTRAINT oorel_od_manhole_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_manhole_surface_inflow ADD CONSTRAINT pkey_qgep_vl_manhole_surface_inflow_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_discharge_point ADD CONSTRAINT oorel_od_discharge_point_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_special_structure_stormwater_tank_arrangement ADD CONSTRAINT pkey_qgep_vl_special_structure_stormwater_tank_arrangement_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_infiltration_installation ADD CONSTRAINT oorel_od_infiltration_installation_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.od_planning_zone ADD CONSTRAINT oorel_od_planning_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_planning_zone_kind ADD CONSTRAINT pkey_qgep_vl_planning_zone_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_infiltration_zone ADD CONSTRAINT oorel_od_infiltration_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_infiltration_zone_infiltration_capacity ADD CONSTRAINT pkey_qgep_vl_infiltration_zone_infiltration_capacity_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_drainage_system ADD CONSTRAINT oorel_od_drainage_system_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_drainage_system_kind ADD CONSTRAINT pkey_qgep_vl_drainage_system_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_water_body_protection_sector ADD CONSTRAINT oorel_od_water_body_protection_sector_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_water_body_protection_sector_kind ADD CONSTRAINT pkey_qgep_vl_water_body_protection_sector_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_ground_water_protection_perimeter ADD CONSTRAINT oorel_od_ground_water_protection_perimeter_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_groundwater_protection_zone ADD CONSTRAINT oorel_od_groundwater_protection_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_chute_material ADD CONSTRAINT pkey_qgep_vl_chute_material_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_lock ADD CONSTRAINT oorel_od_lock_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_passage ADD CONSTRAINT oorel_od_passage_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_blocking_debris ADD CONSTRAINT oorel_od_blocking_debris_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_dam ADD CONSTRAINT oorel_od_dam_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_dam_kind ADD CONSTRAINT pkey_qgep_vl_dam_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_rock_ramp ADD CONSTRAINT oorel_od_rock_ramp_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_overflow_characteristic_kind_overflow_characteristic ADD CONSTRAINT pkey_qgep_vl_overflow_characteristic_kind_overflow_characteristic_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_characteristic_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6220,6220,'hq','HQ','HQ', 'HQ', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_characteristic_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6221,6221,'qq','QQ','QQ', 'QQ', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_characteristic_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6228,6228,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_characteristic_overflow_characteristic_digital ADD CONSTRAINT pkey_qgep_vl_overflow_characteristic_overflow_characteristic_digital_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_characteristic_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6223,6223,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_characteristic_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6224,6224,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_characteristic_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6225,6225,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_dryweather_downspout ADD CONSTRAINT oorel_od_dryweather_downspout_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_access_aid ADD CONSTRAINT oorel_od_access_aid_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_access_aid_kind ADD CONSTRAINT pkey_qgep_vl_access_aid_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_dryweather_flume ADD CONSTRAINT oorel_od_dryweather_flume_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_dryweather_flume_material ADD CONSTRAINT pkey_qgep_vl_dryweather_flume_material_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_cover ADD CONSTRAINT oorel_od_cover_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_cover_venting ADD CONSTRAINT pkey_qgep_vl_cover_venting_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_electric_equipment ADD CONSTRAINT oorel_od_electric_equipment_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_electric_equipment_kind ADD CONSTRAINT pkey_qgep_vl_electric_equipment_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_electromechanical_equipment ADD CONSTRAINT oorel_od_electromechanical_equipment_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_electromechanical_equipment_kind ADD CONSTRAINT pkey_qgep_vl_electromechanical_equipment_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_benching ADD CONSTRAINT oorel_od_benching_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.od_building ADD CONSTRAINT oorel_od_building_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_reservoir ADD CONSTRAINT oorel_od_reservoir_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE;
ALTER TABLE qgep.od_individual_surface ADD CONSTRAINT oorel_od_individual_surface_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_prank_weir_weir_kind ADD CONSTRAINT pkey_qgep_vl_prank_weir_weir_kind_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_pump ADD CONSTRAINT oorel_od_pump_overflow FOREIGN KEY (obj_id) REFERENCES qgep.od_overflow(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_pump_usage_current ADD CONSTRAINT pkey_qgep_vl_pump_usage_current_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_leapingweir ADD CONSTRAINT oorel_od_leapingweir_overflow FOREIGN KEY (obj_id) REFERENCES qgep.od_overflow(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_hydraulic_characteristic_data_is_overflowing ADD CONSTRAINT pkey_qgep_vl_hydraulic_characteristic_data_is_overflowing_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_characteristic_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5774,5774,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5775,5775,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5778,5778,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_hydraulic_characteristic_data_main_weir_kind ADD CONSTRAINT pkey_qgep_vl_hydraulic_characteristic_data_main_weir_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_characteristic_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6422,6422,'leapingweir','Leapingwehr','LEAPING_WEIR', 'zzz_Leapingwehr', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6420,6420,'spillway_raised','Streichwehr_hochgezogen','deversoir_lateral_a_seuil_sureleve', 'stramazzo_laterale_alto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6421,6421,'spillway_low','Streichwehr_niedrig','deversoir_lateral_a_seuil_abaisse', 'stamazzo_laterale_basso', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_hydraulic_characteristic_data_pump_characteristics ADD CONSTRAINT pkey_qgep_vl_hydraulic_characteristic_data_pump_characteristics_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6374,6374,'alternating','alternierend','alterne', 'alternato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6375,6375,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6376,6376,'single','einzeln','individuel', 'singolo', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6377,6377,'parallel','parallel','parallele', 'parallelo', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6378,6378,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_hydraulic_characteristic_data_pump_usage_current ADD CONSTRAINT pkey_qgep_vl_hydraulic_characteristic_data_pump_usage_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6361,6361,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6362,6362,'creek_water','Bachwasser','eaux_cours_d_eau', 'acqua_corso_acqua', 'ape_curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6363,6363,'discharged_combined_wastewater','entlastetes_Mischabwasser','eaux_mixtes_deversees', 'acque_miste_scaricate', 'ape_mixte_deversate', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6364,6364,'industrial_wastewater','Industrieabwasser','eaux_industrielles', 'acque_industriali', 'ape_industriale', '', 'CW', 'EUC', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6365,6365,'combined_wastewater','Mischabwasser','eaux_mixtes', 'acque_miste', 'ape_mixte', '', 'MW', 'EUM', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6366,6366,'rain_wastewater','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'apa_meteorica', '', 'RW', 'EUP', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6367,6367,'clean_wastewater','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EUR', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6368,6368,'wastewater','Schmutzabwasser','eaux_usees', 'acque_luride', '', '', 'SW', 'EU', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6369,6369,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_hydraulic_characteristic_data_status ADD CONSTRAINT pkey_qgep_vl_hydraulic_characteristic_data_status_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_characteristic_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6371,6371,'planned','geplant','prevu', 'pianificato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6372,6372,'current','Ist','actuel', 'attuale', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_characteristic_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6373,6373,'current_optimized','Ist_optimiert','actuel_opt', 'attuale_ottimizzato', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_solids_retention_type ADD CONSTRAINT pkey_qgep_vl_solids_retention_type_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_tank_cleaning ADD CONSTRAINT oorel_od_tank_cleaning_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_tank_cleaning_type ADD CONSTRAINT pkey_qgep_vl_tank_cleaning_type_code PRIMARY KEY (code);
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_tank_emptying ADD CONSTRAINT oorel_od_tank_emptying_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE;
