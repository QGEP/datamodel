...
CREATE TABLE IF NOT EXISTS qgep.SRID (srid integer DEFAULT 21781);
INSERT INTO qgep.SRID(srid) VALUES(3844);
...
SELECT AddGeometryColumn('qgep', 'txt_symbol', 'symbolpos_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'txt_text', 'textpos_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_control_center', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_bathing_area', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_aquifier', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_water_catchment', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_water_control_structure', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_sector_water_body', 'progression_geometry', (SELECT srid FROM qgep.SRID), 'LINESTRING', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_water_course_segment', 'from_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_water_course_segment', 'to_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_reach_point', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_wastewater_structure', 'detail_geometry_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_wastewater_structure', 'detail_geometry_3d_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 3, true);
...
SELECT AddGeometryColumn('qgep', 'od_accident', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_hazard_source', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_catchment_area', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_measuring_point', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_planning_zone', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_groundwater_protection_zone', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_ground_water_protection_perimeter', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_water_body_protection_sector', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_drainage_system', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_infiltration_zone', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_cover', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_lake', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_canton', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_municipality', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_wastewater_node', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_reach', 'progression_geometry', (SELECT srid FROM qgep.SRID), 'LINESTRING', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_reach', 'progression_3d_geometry', (SELECT srid FROM qgep.SRID), 'LINESTRING', 3, true);
...
SELECT AddGeometryColumn('qgep', 'od_individual_surface', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_building', 'perimeter_geometry', (SELECT srid FROM qgep.SRID), 'POLYGON', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_building', 'reference_point_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_reservoir', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
SELECT AddGeometryColumn('qgep', 'od_fountain', 'situation_geometry', (SELECT srid FROM qgep.SRID), 'POINT', 2, true);
...
DROP TABLE IF EXISTS qgep.SRID;
COMMIT;
