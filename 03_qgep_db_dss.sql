...
ALTER TABLE qgep.vl_river_kind ADD CONSTRAINT pkey_qgep_vl_river_kind_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (3399,3399,'moor_creek','Moorbach','ruisseau_de_tourbiere', '', '', '', 'true');
...
ALTER TABLE qgep.vl_maintenance_event_kind ADD CONSTRAINT pkey_qgep_vl_maintenance_event_kind_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, abbr_en, abbr_de, abbr_fr, active) VALUES (4564,4564,'examination','Untersuchung','examen', '', '', '', 'true');
