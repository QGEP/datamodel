...
COMMENT ON COLUMN qgep.re_maintenance_event_wastewater_structure.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
...
COMMENT ON COLUMN qgep.txt_symbol.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.txt_symbol ADD COLUMN symbolpos_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.txt_symbol.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.txt_symbol ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.txt_symbol.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.txt_text.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.txt_text ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.txt_text.remark IS 'General remarks';
...
ALTER TABLE qgep.txt_text ADD COLUMN textpos_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_mutation.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_mutation ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_mutation.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_mutation ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_mutation.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_aquifier.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_aquifier ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
ALTER TABLE qgep.od_aquifier ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_aquifier.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_aquifier ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_aquifier.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_surface_water_bodies.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_surface_water_bodies ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_surface_water_bodies.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_surface_water_bodies ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_surface_water_bodies.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_river.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_lake.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_lake ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_water_course_segment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_water_course_segment ADD COLUMN from_geometry geometry('POINT', :SRID);
...
ALTER TABLE qgep.od_water_course_segment ADD COLUMN remark  text ;
...
ALTER TABLE qgep.od_water_course_segment ADD COLUMN to_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_water_course_segment.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_water_course_segment ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_water_course_segment.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_water_catchment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_water_catchment ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_water_catchment.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_water_catchment ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_water_catchment.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_water_catchment ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_water_catchment.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_river_bank.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_river_bank ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_river_bed.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_river_bed ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_river_bed.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_river_bed ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_river_bed.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_sector_water_body.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_sector_water_body ADD COLUMN progression_geometry geometry('COMPOUNDCURVE', :SRID);
...
ALTER TABLE qgep.od_sector_water_body ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_sector_water_body.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_sector_water_body ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_sector_water_body.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_organisation.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_organisation ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_organisation.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_organisation ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_organisation.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_cooperative.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_canton.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_canton ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_waste_water_association.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_municipality.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_municipality ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_administrative_office.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_waste_water_treatment_plant.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_private.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_wastewater_structure.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN detail_geometry_geometry geometry('CURVEPOLYGONZ', :SRID);
...
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_wastewater_structure.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_wastewater_structure.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_channel.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_manhole.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_discharge_point.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_special_structure.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_infiltration_installation.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_wwtp_structure.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_maintenance_event.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_maintenance_event.operator IS 'Operator of operating company or administration / Sachbearbeiter Firma oder Verwaltung (kann auch Operateur sein bei Untersuchung) / Responsable de saisie du bureau';
...
ALTER TABLE qgep.od_maintenance_event ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_maintenance_event.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_maintenance_event ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_maintenance_event.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_zone.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_zone ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_zone.identifier IS '';
ALTER TABLE qgep.od_zone ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_zone.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_zone ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_zone.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_planning_zone.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_planning_zone ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_infiltration_zone.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_infiltration_zone ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_drainage_system.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_drainage_system ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_water_body_protection_sector.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_water_body_protection_sector ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_ground_water_protection_perimeter.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_ground_water_protection_perimeter ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_groundwater_protection_zone.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_groundwater_protection_zone ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_pipe_profile.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_pipe_profile ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_pipe_profile.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_pipe_profile ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_pipe_profile.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_wwtp_energy_use.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wwtp_energy_use ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_wwtp_energy_use.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_wwtp_energy_use ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_wwtp_energy_use.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_waste_water_treatment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_waste_water_treatment ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_sludge_treatment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_sludge_treatment ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_sludge_treatment.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_sludge_treatment ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_sludge_treatment.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_control_center.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_control_center ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_control_center.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_control_center ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_control_center.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_water_control_structure.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_water_control_structure ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_water_control_structure.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_water_control_structure ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_water_control_structure.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_water_control_structure ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_water_control_structure.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_ford.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_chute.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_lock.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_passage.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_blocking_debris.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_dam.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_rock_ramp.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_fish_pass.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_fish_pass ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_fish_pass.identifier IS '';
ALTER TABLE qgep.od_fish_pass ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_bathing_area.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_bathing_area ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_bathing_area.identifier IS '';
ALTER TABLE qgep.od_bathing_area ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_bathing_area.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_bathing_area ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_bathing_area.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_bathing_area ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_bathing_area.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_hydr_geometry.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_hydr_geometry ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_hydr_geometry.identifier IS '';
ALTER TABLE qgep.od_hydr_geometry ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_hydr_geometry.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_hydr_geometry ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hydr_geometry.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_wastewater_networkelement.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wastewater_networkelement ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_wastewater_networkelement.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_wastewater_networkelement ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_wastewater_networkelement.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_reach_point.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_reach_point ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_reach_point.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_reach_point ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_wastewater_node.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wastewater_node ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_reach.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_reach ADD COLUMN progression_geometry geometry('COMPOUNDCURVEZ', :SRID);
...
COMMENT ON COLUMN qgep.od_profile_geometry.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_profile_geometry.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_profile_geometry ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_profile_geometry.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_hydr_geom_relation.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_hydr_geom_relation.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_hydr_geom_relation ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hydr_geom_relation.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_mechanical_pretreatment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_mechanical_pretreatment ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_mechanical_pretreatment.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_mechanical_pretreatment ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_mechanical_pretreatment.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_retention_body.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_retention_body ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_retention_body.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_retention_body ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_retention_body.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
-------
-------
CREATE TABLE qgep.od_overflow_char
(
   obj_id varchar(16) NOT NULL,
...
CREATE SEQUENCE qgep.seq_od_overflow_char_oid INCREMENT 1 MINVALUE 0 MAXVALUE 999999 START 0;
 ALTER TABLE qgep.od_overflow_char ALTER COLUMN obj_id SET DEFAULT qgep.generate_oid('od_overflow_char');
COMMENT ON COLUMN qgep.od_overflow_char.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_overflow_char ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_overflow_char.identifier IS '';
ALTER TABLE qgep.od_overflow_char ADD COLUMN kind_overflow_characteristic  integer ;
COMMENT ON COLUMN qgep.od_overflow_char.kind_overflow_characteristic IS 'yyy_Die Kennlinie ist als Q /Q- (bei Bodenöffnungen) oder als H/Q-Tabelle (bei Streichwehren) zu dokumentieren. Bei einer freien Aufteilung muss die Kennlinie nicht dokumentiert werden. Bei Abflussverhältnissen in Einstaubereichen ist die Funktion separat in einer Beilage zu beschreiben. / Die Kennlinie ist als Q /Q- (bei Bodenöffnungen) oder als H/Q-Tabelle (bei Streichwehren) zu dokumentieren. Bei einer freien Aufteilung muss die Kennlinie nicht dokumentiert werden. Bei Abflussverhältnissen in Einstaubereichen ist die Funktion separat in einer Beilage zu beschreiben. / La courbe est à documenter sous forme de rapport Q/Q (Leaping weir) ou H/Q (déversoir latéral). Les conditions d’écoulement dans la chambre d’accumulation sont à fournir en annexe.';
ALTER TABLE qgep.od_overflow_char ADD COLUMN overflow_characteristic_digital  integer ;
COMMENT ON COLUMN qgep.od_overflow_char.overflow_characteristic_digital IS 'yyy_Falls Kennlinie_digital = ja müssen die Attribute für die Q-Q oder H-Q Beziehung  in Ueberlaufcharakteristik ausgefüllt sein in HQ_Relation. / Falls Kennlinie_digital = ja müssen die Attribute für die Q-Q oder H-Q Beziehung in HQ_Relation ausgefüllt sein. / Si courbe de fonctionnement numérique = oui, les attributs pour les relations Q-Q et H-Q doivent être saisis dans la classe RELATION_HQ.';
ALTER TABLE qgep.od_overflow_char ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_overflow_char.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_overflow_char ADD COLUMN last_modification TIMESTAMP without time zone DEFAULT now();
COMMENT ON COLUMN qgep.od_overflow_char.last_modification IS 'Last modification / Letzte_Aenderung / Derniere_modification: INTERLIS_1_DATE';
ALTER TABLE qgep.od_overflow_char ADD COLUMN fk_dataowner varchar(16);
COMMENT ON COLUMN qgep.od_overflow_char.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_overflow_char ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_overflow_char.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
update_last_modified_overflow_char
BEFORE UPDATE OR INSERT ON
 qgep.od_overflow_char
FOR EACH ROW EXECUTE PROCEDURE
 qgep.update_last_modified();
...
COMMENT ON COLUMN qgep.od_hq_relation.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_hq_relation.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_hq_relation ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hq_relation.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_structure_part.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_structure_part ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_structure_part.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_structure_part ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_structure_part.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_dryweather_downspout.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_access_aid.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_dryweather_flume.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_cover.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_cover ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_electric_equipment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_electromechanical_equipment.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_benching.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_connection_object.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_connection_object ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_connection_object.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_connection_object ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_connection_object.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_building.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_building ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
ALTER TABLE qgep.od_building ADD COLUMN reference_point_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_reservoir.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_reservoir ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_individual_surface.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_individual_surface ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
COMMENT ON COLUMN qgep.od_fountain.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_fountain ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_hazard_source.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_hazard_source ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_hazard_source.identifier IS '';
ALTER TABLE qgep.od_hazard_source ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_hazard_source.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_hazard_source ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_hazard_source.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_hazard_source ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hazard_source.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_accident.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_accident ADD COLUMN remark  text ;
...
ALTER TABLE qgep.od_accident ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_accident.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_accident ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_accident.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_substance.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_substance ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_substance.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_substance ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_substance.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_catchment_area.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_catchment_area ADD COLUMN perimeter_geometry geometry('CURVEPOLYGON', :SRID);
...
ALTER TABLE qgep.od_catchment_area ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_catchment_area.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_catchment_area ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_catchment_area.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_surface_runoff_parameters.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_surface_runoff_parameters ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_surface_runoff_parameters.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_surface_runoff_parameters ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_surface_runoff_parameters.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_measuring_point.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_measuring_point ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_measuring_point.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_measuring_point ADD COLUMN situation_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_measuring_point.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_measuring_point ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_measuring_point.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_measuring_device.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_measuring_device ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_measuring_device.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_measuring_device ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_measuring_device.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_measurement_series.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_measurement_series ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_measurement_series.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_measurement_series ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_measurement_series.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_measurement_result.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_measurement_result ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_measurement_result.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_measurement_result ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_measurement_result.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_overflow.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_overflow ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_overflow.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_overflow ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_overflow.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_throttle_shut_off_unit.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_throttle_shut_off_unit ADD COLUMN remark  text ;
...
COMMENT ON COLUMN qgep.od_throttle_shut_off_unit.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_throttle_shut_off_unit ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_throttle_shut_off_unit.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
...
COMMENT ON COLUMN qgep.od_prank_weir.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_pump.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_leapingweir.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
-------
-------
CREATE TABLE qgep.od_hydraulic_char_data
(
   obj_id varchar(16) NOT NULL,
...
CREATE SEQUENCE qgep.seq_od_hydraulic_char_data_oid INCREMENT 1 MINVALUE 0 MAXVALUE 999999 START 0;
 ALTER TABLE qgep.od_hydraulic_char_data ALTER COLUMN obj_id SET DEFAULT qgep.generate_oid('od_hydraulic_char_data');
COMMENT ON COLUMN qgep.od_hydraulic_char_data.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN aggregate_number  smallint ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.aggregate_number IS '';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN delivery_height_geodaetic  decimal(6,2) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.delivery_height_geodaetic IS '';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN identifier  varchar(20) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.identifier IS '';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN is_overflowing  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.is_overflowing IS 'yyy_Angabe, ob die Entlastung beim Dimensionierungsereignis anspringt / Angabe, ob die Entlastung beim Dimensionierungsereignis anspringt / Indication, si le déversoir déverse lors des événements pour lesquels il a été dimensionné.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN main_weir_kind  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.main_weir_kind IS 'yyy_Art des Hauptwehrs am Knoten, falls mehrere Überläufe / Art des Hauptwehrs am Knoten, falls mehrere Überläufe / Genre du déversoir principal du noeud concerné s''il y a plusieurs déversoirs.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN overcharge  decimal (5,2) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.overcharge IS 'yyy_Optimale Mehrbelastung nach der Umsetzung der Massnahmen. / Ist: Mehrbelastung der untenliegenden Kanäle beim Dimensionierungsereignis = 100 * (Qab – Qan) / Qan 	[%]. Verhältnis zwischen der abgeleiteten Abwassermengen Richtung ARA beim Anspringen des Entlastungsbauwerkes (Qan) und Qab (Abwassermenge, welche beim Dimensionierungsereignis (z=5) weiter im Kanalnetz Richtung Abwasserreinigungsanlage abgeleitet wird). Beispiel: Qan = 100 l/s, Qab = 150 l/s -> Mehrbelastung = 50%; Ist_optimiert: Optimale Mehrbelastung im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen; geplant: Optimale Mehrbelastung nach der Umsetzung der Massnahmen. / Etat actuel: Surcharge optimale à l’état actuel avant la réalisation d’éventuelles mesures;  actuel optimisé: Surcharge optimale à l’état actuel avant la réalisation d’éventuelles mesures; prévu: Optimale Mehrbelastung nach der Umsetzung der Massnahmen.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN overflow_duration  decimal(6,1) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.overflow_duration IS 'yyy_Mittlere Überlaufdauer pro Jahr. Bei Ist_Zustand: Berechnung mit geplanten Massnahmen. Bei Ist_optimiert:  Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit geplanten Massnahmen / Mittlere Überlaufdauer pro Jahr. Bei Ist_Zustand: Berechnung mit geplanten Massnahmen. Bei Ist_optimiert:  Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit geplanten Massnahmen / Durée moyenne de déversement par an.  Actuel: Durée moyenne de déversement par an selon des simulations pour de longs temps de retour (z > 10). Actuel optimizé: Calcul en mode optimal à l’état actuel avant la réalisation d’éventuelles mesures. Prévu: Calcul selon les mesures planifiées';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN overflow_freight  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.overflow_freight IS 'yyy_Mittlere Ueberlaufschmutzfracht pro Jahr / Mittlere Ueberlaufschmutzfracht pro Jahr / Charge polluante moyenne déversée par année';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN overflow_frequency  decimal(3,1) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.overflow_frequency IS 'yyy_Mittlere Überlaufhäufigkeit pro Jahr. Ist Zustand: Durchschnittliche Überlaufhäufigkeit pro Jahr von Entlastungsanlagen gemäss Langzeitsimulation (Dauer mindestens 10 Jahre). Ist optimiert: Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit Einstellungen nach der Umsetzung der Massnahmen / Mittlere Überlaufhäufigkeit pro Jahr. Ist Zustand: Durchschnittliche Überlaufhäufigkeit pro Jahr von Entlastungsanlagen gemäss Langzeitsimulation (Dauer mindestens 10 Jahre). Ist optimiert: Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit Einstellungen nach der Umsetzung der Massnahmen / Fréquence moyenne de déversement par an. Fréquence moyenne de déversement par an selon des simulations pour de longs temps de retour (z > 10). Actuel optimizé: Calcul en mode optimal à l’état actuel avant la réalisation d’éventuelles mesures. Prévu: Calcul après la réalisation d’éventuelles mesures.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN overflow_volume  decimal(9,2) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.overflow_volume IS 'yyy_Mittlere Überlaufwassermenge pro Jahr. Durchschnittliche Überlaufmenge pro Jahr von Entlastungsanlagen gemäss Langzeitsimulation (Dauer mindestens 10 Jahre). Ist optimiert: Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit Einstellungen nach der Umsetzung der Massnahmen / Mittlere Überlaufwassermenge pro Jahr. Durchschnittliche Überlaufmenge pro Jahr von Entlastungsanlagen gemäss Langzeitsimulation (Dauer mindestens 10 Jahre). Ist optimiert: Berechnung mit optimierten Einstellungen im Ist-Zustand vor der Umsetzung von allfälligen weiteren Massnahmen. Planungszustand: Berechnung mit Einstellungen nach der Umsetzung der Massnahmen / Volume moyen déversé par an. Volume moyen déversé par an selon des simulations pour de longs temps de retour (z > 10). Actuel optimizé: Calcul en mode optimal à l’état actuel avant la réalisation d’éventuelles mesures. Prévu: Calcul après la réalisation d’éventuelles mesures.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN pump_characteristics  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.pump_characteristics IS 'yyy_Bei speziellen Betriebsarten ist die Funktion separat zu dokumentieren und der Stammkarte beizulegen. / Bei speziellen Betriebsarten ist die Funktion separat zu dokumentieren und der Stammkarte beizulegen. / Pour de régime de fonctionnement spéciaux, cette fonction doit être documentée séparément et annexée à la fiche technique';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN pump_flow_max  decimal(9,3) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.pump_flow_max IS 'yyy_Maximaler Förderstrom der Pumpen (gesamtes Bauwerk). Tritt in der Regel bei der minimalen Förderhöhe ein. / Maximaler Förderstrom der Pumpen (gesamtes Bauwerk). Tritt in der Regel bei der minimalen Förderhöhe ein. / Débit de refoulement maximal de toutes les pompes de l’ouvrage. Survient normalement à la hauteur min de refoulement.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN pump_flow_min  decimal(9,3) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.pump_flow_min IS 'yyy_Minimaler Förderstrom der Pumpen zusammen (gesamtes Bauwerk). Tritt in der Regel bei der maximalen Förderhöhe ein. / Minimaler Förderstrom der Pumpen zusammen (gesamtes Bauwerk). Tritt in der Regel bei der maximalen Förderhöhe ein. / Débit de refoulement minimal de toutes les pompes de l’ouvrage. Survient normalement à la hauteur max de refoulement.';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN pump_usage_current  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.pump_usage_current IS 'yyy_Nutzungsart_Ist des gepumpten Abwassers. / Nutzungsart_Ist des gepumpten Abwassers. / Genre d''utilisation actuel de l''eau usée pompée';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN q_discharge  decimal(9,3) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.q_discharge IS 'yyy_Qab gemäss GEP / Qab gemäss GEP / Qeff selon PGEE';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN qon  decimal(9,3) ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.qon IS 'yyy_Wassermenge, bei welcher der Überlauf anspringt / Wassermenge, bei welcher der Überlauf anspringt / Débit à partir duquel le déversoir devrait être fonctionnel';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.remark IS 'General remarks / Allgemeine Bemerkungen / Remarques générales';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN status  integer ;
COMMENT ON COLUMN qgep.od_hydraulic_char_data.status IS 'yyy_Planungszustand der Hydraulischen Kennwerte (zwingend). Ueberlaufcharakteristik und Gesamteinzugsgebiet kann für verschiedene Stati gebildet werden und leitet sich aus dem Status der Hydr_Kennwerte ab. / Planungszustand der Hydraulischen Kennwerte (zwingend). Ueberlaufcharakteristik und Gesamteinzugsgebiet kann für verschiedene Stati gebildet werden und leitet sich aus dem Status der Hydr_Kennwerte ab. / Etat prévu des caractéristiques hydrauliques (obligatoire). Les caractéristiques de déversement et le bassin versant global peuvent être représentés à différents états et se laissent déduire à partir de l’attribut PARAMETRES_HYDR';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN last_modification TIMESTAMP without time zone DEFAULT now();
COMMENT ON COLUMN qgep.od_hydraulic_char_data.last_modification IS 'Last modification / Letzte_Aenderung / Derniere_modification: INTERLIS_1_DATE';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN fk_dataowner varchar(16);
COMMENT ON COLUMN qgep.od_hydraulic_char_data.fk_dataowner IS 'Foreignkey to Metaattribute dataowner (as an organisation) - this is the person or body who is allowed to delete, change or maintain this object / Metaattribut Datenherr ist diejenige Person oder Stelle, die berechtigt ist, diesen Datensatz zu löschen, zu ändern bzw. zu verwalten / Maître des données gestionnaire de données, qui est la personne ou l''organisation autorisée pour gérer, modifier ou supprimer les données de cette table/classe';
ALTER TABLE qgep.od_hydraulic_char_data ADD COLUMN fk_provider varchar (16);
COMMENT ON COLUMN qgep.od_hydraulic_char_data.fk_provider IS 'Foreignkey to Metaattribute provider (as an organisation) - this is the person or body who delivered the data / Metaattribut Datenlieferant ist diejenige Person oder Stelle, die die Daten geliefert hat / FOURNISSEUR DES DONNEES Organisation qui crée l’enregistrement de ces données ';
-------
CREATE TRIGGER
update_last_modified_hydraulic_char_data
BEFORE UPDATE OR INSERT ON
 qgep.od_hydraulic_char_data
FOR EACH ROW EXECUTE PROCEDURE
 qgep.update_last_modified();
...
COMMENT ON COLUMN qgep.od_backflow_prevention.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_solids_retention.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_tank_cleaning.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_tank_emptying.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_param_ca_general.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
COMMENT ON COLUMN qgep.od_param_ca_mouse1.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.vl_symbol_plantype ADD CONSTRAINT pkey_qgep_vl_symbol_plantype_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7876,7876,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7877,7877,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7878,7878,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7875,7875,'network_plan','Werkplan','plan_de_reseau', 'zzz_Werkplan', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.txt_symbol ADD COLUMN fk_wastewater_structure varchar (16);
ALTER TABLE qgep.txt_symbol ADD CONSTRAINT rel_symbol_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE cascade;
...
ALTER TABLE qgep.vl_text_plantype ADD CONSTRAINT pkey_qgep_vl_text_plantype_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7844,7844,'pipeline_registry','Leitungskataster','cadastre_des_conduites_souterraines', 'catasto_delle_canalizzazioni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7846,7846,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7847,7847,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7848,7848,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7845,7845,'network_plan','Werkplan','plan_de_reseau', '', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_text_texthali ADD CONSTRAINT pkey_qgep_vl_text_texthali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7850,7850,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7851,7851,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7852,7852,'2','2','2', '2', '2', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_text_textvali ADD CONSTRAINT pkey_qgep_vl_text_textvali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7853,7853,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7854,7854,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7855,7855,'2','2','2', '2', '2', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7856,7856,'3','3','3', '3', '3', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7857,7857,'4','4','4', '4', '4', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.txt_text ADD COLUMN fk_wastewater_structure varchar (16);
ALTER TABLE qgep.txt_text ADD CONSTRAINT rel_text_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE cascade;
ALTER TABLE qgep.txt_text ADD COLUMN fk_catchment_area varchar (16);
ALTER TABLE qgep.txt_text ADD CONSTRAINT rel_text_catchment_area FOREIGN KEY (fk_catchment_area) REFERENCES qgep.od_catchment_area(obj_id) ON DELETE cascade;
ALTER TABLE qgep.txt_text ADD COLUMN fk_reach varchar (16);
ALTER TABLE qgep.txt_text ADD CONSTRAINT rel_text_reach FOREIGN KEY (fk_reach) REFERENCES qgep.od_reach(obj_id) ON DELETE cascade;
...
ALTER TABLE qgep.vl_mutation_kind ADD CONSTRAINT pkey_qgep_vl_mutation_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_mutation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5523,5523,'created','erstellt','cree', 'zzz_erstellt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mutation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5582,5582,'changed','geaendert','changee', 'zzz_geaendert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mutation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5583,5583,'deleted','geloescht','effacee', 'zzz_geloescht', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_river ADD CONSTRAINT oorel_od_river_surface_water_bodies FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_water_bodies(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_river_kind ADD CONSTRAINT pkey_qgep_vl_river_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3397,3397,'englacial_river','Gletscherbach','ruisseau_de_glacier', 'zzz_Gletscherbach', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3399,3399,'moor_creek','Moorbach','ruisseau_de_tourbiere', 'zzz_Moorbach', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3398,3398,'lake_outflow','Seeausfluss','effluent_d_un_lac', 'zzz_Seeausfluss', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3396,3396,'travertine_river','Travertinbach','ruisseau_sur_fond_tufcalcaire', 'zzz_Travertinbach', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3400,3400,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_lake ADD CONSTRAINT oorel_od_lake_surface_water_bodies FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_water_bodies(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_water_course_segment_algae_growth ADD CONSTRAINT pkey_qgep_vl_water_course_segment_algae_growth_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_algae_growth (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2623,2623,'none_or_marginal','kein_gering','absent_faible', 'zzz_kein_gering', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_algae_growth (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2624,2624,'moderate_to_strong','maessig_stark','moyen_fort', 'zzz_maessig_stark', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_algae_growth (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2625,2625,'excessive_rampant','uebermaessig_wuchernd','tres_fort_proliferation', 'zzz_uebermaessig_wuchernd', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_algae_growth (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3050,3050,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_altitudinal_zone ADD CONSTRAINT pkey_qgep_vl_water_course_segment_altitudinal_zone_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_altitudinal_zone (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (320,320,'alpine','alpin','alpin', 'zzz_alpin', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_altitudinal_zone (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (294,294,'foothill_zone','kollin','des_collines', 'zzz_kollin', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_altitudinal_zone (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (295,295,'montane','montan','montagnard', 'zzz_montan', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_altitudinal_zone (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (319,319,'subalpine','subalpin','subalpin', 'zzz_subalpin', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_altitudinal_zone (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3020,3020,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_dead_wood ADD CONSTRAINT pkey_qgep_vl_water_course_segment_dead_wood_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_dead_wood (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2629,2629,'accumulations','Ansammlungen','amas', 'zzz_Ansammlungen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_dead_wood (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2631,2631,'none_or_sporadic','kein_vereinzelt','absent_localise', 'zzz_kein_vereinzelt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_dead_wood (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3052,3052,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_dead_wood (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2630,2630,'scattered','zerstreut','dissemine', 'zzz_zerstreut', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_depth_variability ADD CONSTRAINT pkey_qgep_vl_water_course_segment_depth_variability_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_depth_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2617,2617,'pronounced','ausgepraegt','prononcee', 'zzz_ausgepraegt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_depth_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2619,2619,'none','keine','aucune', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_depth_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2618,2618,'moderate','maessig','moyenne', 'zzz_maessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_depth_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3049,3049,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_discharge_regime ADD CONSTRAINT pkey_qgep_vl_water_course_segment_discharge_regime_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_discharge_regime (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (297,297,'compromised','beeintraechtigt','modifie', 'zzz_beeintraechtigt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_discharge_regime (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (428,428,'artificial','kuenstlich','artificiel', 'zzz_kuenstlich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_discharge_regime (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (427,427,'hardly_natural','naturfern','peu_naturel', 'zzz_naturfern', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_discharge_regime (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (296,296,'close_to_natural','naturnah','presque_naturel', 'zzz_naturnah', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_discharge_regime (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3091,3091,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_ecom_classification ADD CONSTRAINT pkey_qgep_vl_water_course_segment_ecom_classification_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3496,3496,'covered','eingedolt','mis_sous_terre', 'zzz_eingedolt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3495,3495,'artificial','kuenstlich_naturfremd','artificiel_peu_naturel', 'zzz_kuenstlich_naturfremd', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3492,3492,'natural_or_seminatural','natuerlich_naturnah','naturel_presque_naturel', 'zzz_natuerlich_naturnah', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3491,3491,'not_classified','nicht_klassiert','pas_classifie', 'zzz_nicht_klassiert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3494,3494,'heavily_compromised','stark_beeintraechtigt','fortement_modifie', 'zzz_stark_beeintraechtigt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_ecom_classification (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3493,3493,'partially_compromised','wenig_beeintraechtigt','peu_modifie', 'zzz_wenig_beeintraechtigt', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_kind ADD CONSTRAINT pkey_qgep_vl_water_course_segment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2710,2710,'covered','eingedolt','mis_sous_terre', 'zzz_eingedolt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2709,2709,'open','offen','ouvert', 'zzz_offen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3058,3058,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_length_profile ADD CONSTRAINT pkey_qgep_vl_water_course_segment_length_profile_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_length_profile (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (97,97,'downwelling','kaskadenartig','avec_des_cascades', 'zzz_kaskadenartig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_length_profile (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3602,3602,'rapids_or_potholes','Schnellen_Kolke','avec_rapides_marmites', 'zzz_Schnellen_Kolke', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_length_profile (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (99,99,'continuous','stetig','continu', 'zzz_stetig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_length_profile (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3035,3035,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_macrophyte_coverage ADD CONSTRAINT pkey_qgep_vl_water_course_segment_macrophyte_coverage_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_macrophyte_coverage (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2626,2626,'none_or_marginal','kein_gering','absent_faible', 'zzz_kein_gering', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_macrophyte_coverage (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2627,2627,'moderate_to_strong','maessig_stark','moyen_fort', 'zzz_maessig_stark', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_macrophyte_coverage (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2628,2628,'excessive_rampant','uebermaessig_wuchernd','tres_fort_proliferation', 'zzz_uebermaessig_wuchernd', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_macrophyte_coverage (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3051,3051,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_section_morphology ADD CONSTRAINT pkey_qgep_vl_water_course_segment_section_morphology_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_section_morphology (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4575,4575,'straight','gerade','rectiligne', 'zzz_gerade', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_section_morphology (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4580,4580,'moderately_bent','leichtbogig','legerement_incurve', 'zzz_leichtbogig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_section_morphology (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4579,4579,'meandering','maeandrierend','en_meandres', 'zzz_maeandrierend', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_section_morphology (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4578,4578,'heavily_bent','starkbogig','fortement_incurve', 'zzz_starkbogig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_section_morphology (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4576,4576,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_slope ADD CONSTRAINT pkey_qgep_vl_water_course_segment_slope_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_slope (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (291,291,'shallow_dipping','flach','plat', 'piano', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_slope (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (292,292,'moderate_slope','mittel','moyen', 'medio', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_slope (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (293,293,'steep','steil','raide', 'ripido', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_slope (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3019,3019,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_utilisation ADD CONSTRAINT pkey_qgep_vl_water_course_segment_utilisation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_utilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (384,384,'recreation','Erholung','detente', 'zzz_Erholung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_utilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (429,429,'fishing','Fischerei','peche', 'zzz_Fischerei', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_utilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (385,385,'dam','Stauanlage','installation_de_retenue', 'zzz_Stauanlage', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_utilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3039,3039,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_water_hardness ADD CONSTRAINT pkey_qgep_vl_water_course_segment_water_hardness_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_water_hardness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (321,321,'limestone','Kalk','calcaire', 'zzz_Kalk', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_water_hardness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (322,322,'silicate','Silikat','silicieuse', 'zzz_Silikat', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_water_hardness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3024,3024,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_course_segment_width_variability ADD CONSTRAINT pkey_qgep_vl_water_course_segment_width_variability_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_course_segment_width_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (176,176,'pronounced','ausgepraegt','prononcee', 'zzz_ausgepraegt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_width_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (177,177,'limited','eingeschraenkt','limitee', 'zzz_eingeschraenkt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_width_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (178,178,'none','keine','nulle', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_course_segment_width_variability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3078,3078,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_water_catchment_kind ADD CONSTRAINT pkey_qgep_vl_water_catchment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_catchment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (24,24,'process_water','Brauchwasser','eau_industrielle', 'zzz_Brauchwasser', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_catchment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (25,25,'drinking_water','Trinkwasser','eau_potable', 'zzz_Trinkwasser', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_catchment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3075,3075,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_control_grade_of_river ADD CONSTRAINT pkey_qgep_vl_river_bank_control_grade_of_river_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (341,341,'none','keine','nul', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2612,2612,'moderate','maessig','moyen', 'zzz_maessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2613,2613,'strong','stark','fort', 'zzz_stark', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2614,2614,'predominantly','ueberwiegend','preponderant', 'zzz_ueberwiegend', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3026,3026,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2611,2611,'sporadic','vereinzelt','localise', 'zzz_vereinzelt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2615,2615,'complete','vollstaendig','total', 'zzz_vollstaendig', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_river_control_type ADD CONSTRAINT pkey_qgep_vl_river_bank_river_control_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3489,3489,'other_impermeable','andere_dicht','autres_impermeables', 'zzz_altri_dicht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3486,3486,'concrete_chequer_brick_impermeable','Betongitterstein_dicht','brique_perforee_en_beton_impermeable', 'zzz_Betongitterstein_dicht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3485,3485,'wood_permeable','Holz_durchlaessig','bois_permeable', 'zzz_Holz_durchlaessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3482,3482,'no_control_structure','keine_Verbauung','aucun_amenagement', 'zzz_keine_Verbauung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3483,3483,'living_control_structure_permeable','Lebendverbau_durchlaessig','materiau_vegetal_permeable', 'zzz_Lebendverbau_durchlaessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3488,3488,'wall_impermeable','Mauer_dicht','mur_impermeable', 'zzz_Mauer_dicht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3487,3487,'natural_stone_impermeable','Naturstein_dicht','pierre_naturelle_impermeable', 'zzz_Naturstein_dicht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3484,3484,'loose_natural_stone_permeable','Naturstein_locker_durchlaessig','pierre_naturelle_lache', 'zzz_Naturstein_locker_durchlaessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3080,3080,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_shores ADD CONSTRAINT pkey_qgep_vl_river_bank_shores_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_shores (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (404,404,'inappropriate_to_river','gewaesserfremd','atypique_d_un_cours_d_eau', 'zzz_gewaesserfremd', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_shores (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (403,403,'appropriate_to_river','gewaessergerecht','typique_d_un_cours_d_eau', 'zzz_gewaessergerecht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_shores (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (405,405,'artificial','kuenstlich','artificielle', 'zzz_kuenstlich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_shores (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3081,3081,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_side ADD CONSTRAINT pkey_qgep_vl_river_bank_side_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_side (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (420,420,'left','links','gauche', 'zzz_links', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_side (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (421,421,'right','rechts','droite', 'zzz_rechts', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_side (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3065,3065,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_utilisation_of_shore_surroundings ADD CONSTRAINT pkey_qgep_vl_river_bank_utilisation_of_shore_surroundings_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_utilisation_of_shore_surroundings (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (424,424,'developed_area','Bebauungen','constructions', 'zzz_Bebauungen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_utilisation_of_shore_surroundings (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (425,425,'grassland','Gruenland','espaces_verts', 'zzz_Gruenland', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_utilisation_of_shore_surroundings (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3068,3068,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_utilisation_of_shore_surroundings (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (426,426,'forest','Wald','foret', 'zzz_Wald', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bank_vegetation ADD CONSTRAINT pkey_qgep_vl_river_bank_vegetation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bank_vegetation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (325,325,'missing','fehlend','absente', 'zzz_fehlend', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_vegetation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (323,323,'typical_for_habitat','standorttypisch','typique_du_lieu', 'zzz_standorttypisch', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_vegetation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (324,324,'atypical_for_habitat','standortuntypisch','non_typique_du_lieu', 'zzz_standortuntypisch', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bank_vegetation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3025,3025,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bed_control_grade_of_river ADD CONSTRAINT pkey_qgep_vl_river_bed_control_grade_of_river_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (142,142,'none','keine','nul', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2607,2607,'moderate','maessig','moyen', 'zzz_maessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2608,2608,'heavily','stark','fort', 'zzz_stark', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2609,2609,'predominantly','ueberwiegend','preponderant', 'zzz_ueberwiegend', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3085,3085,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2606,2606,'sporadic','vereinzelt','localise', 'zzz_vereinzelt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_control_grade_of_river (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2610,2610,'complete','vollstaendig','total', 'zzz_vollstaendig', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bed_kind ADD CONSTRAINT pkey_qgep_vl_river_bed_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bed_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (290,290,'hard','hart','dur', 'zzz_hart', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3089,3089,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (289,289,'soft','weich','tendre', 'zzz_weich', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_river_bed_river_control_type ADD CONSTRAINT pkey_qgep_vl_river_bed_river_control_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3481,3481,'other_impermeable','andere_dicht','autres_impermeables', 'zzz_altri_dicht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (338,338,'concrete_chequer_brick','Betongittersteine','briques_perforees_en_beton', 'zzz_Betongittersteine', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3479,3479,'wood','Holz','bois', 'zzz_Holz', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3477,3477,'no_control_structure','keine_Verbauung','aucun_amenagement', 'zzz_keine_Verbauung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3478,3478,'rock_fill_or_loose_boulders','Steinschuettung_Blockwurf','pierres_naturelles', 'zzz_Steinschuettung_Blockwurf', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_river_bed_river_control_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3079,3079,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_sector_water_body_kind ADD CONSTRAINT pkey_qgep_vl_sector_water_body_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_sector_water_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2657,2657,'waterbody','Gewaesser','lac_ou_cours_d_eau', 'zzz_Gewaesser', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sector_water_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2729,2729,'parallel_section','ParallelerAbschnitt','troncon_parallele', 'zzz_ParallelerAbschnitt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sector_water_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2728,2728,'lake_traversal','Seetraverse','element_traversant_un_lac', 'zzz_Seetraverse', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sector_water_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2656,2656,'shore','Ufer','rives', 'zzz_Ufer', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sector_water_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3054,3054,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_cooperative ADD CONSTRAINT oorel_od_cooperative_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_canton ADD CONSTRAINT oorel_od_canton_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_waste_water_association ADD CONSTRAINT oorel_od_waste_water_association_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_municipality ADD CONSTRAINT oorel_od_municipality_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_administrative_office ADD CONSTRAINT oorel_od_administrative_office_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_waste_water_treatment_plant ADD CONSTRAINT oorel_od_waste_water_treatment_plant_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_private ADD CONSTRAINT oorel_od_private_organisation FOREIGN KEY (obj_id) REFERENCES qgep.od_organisation(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_wastewater_structure_accessibility ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_accessibility_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_accessibility (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3444,3444,'covered','ueberdeckt','couvert', 'coperto', 'capac', '', 'UED', 'CO', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_accessibility (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3447,3447,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_accessibility (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3446,3446,'inaccessible','unzugaenglich','inaccessible', 'non_accessibile', 'inaccesibil', '', 'UZG', 'NA', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_accessibility (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3445,3445,'accessible','zugaenglich','accessible', 'accessibile', 'accessibil', '', 'ZG', 'A', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_financing ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_financing_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_financing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5510,5510,'public','oeffentlich','public', 'pubblico', 'publica', 'PU', 'OE', 'PU', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_financing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5511,5511,'private','privat','prive', 'privato', 'privata', 'PR', 'PR', 'PR', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_financing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5512,5512,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', 'U', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_renovation_necessity ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_renovation_necessity_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5370,5370,'urgent','dringend','urgente', 'urgente', 'urgent', 'UR', 'DR', 'UR', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5368,5368,'none','keiner','aucune', 'nessuno', 'niciuna', 'N', 'K', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2,2,'short_term','kurzfristig','a_court_terme', 'breve_termine', 'termen_scurt', 'ST', 'KF', 'CT', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4,4,'long_term','langfristig','a_long_terme', 'lungo_termine', 'termen_lung', 'LT', 'LF', 'LT', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3,3,'medium_term','mittelfristig','a_moyen_terme', 'medio_termine', 'termen_mediu', '', 'MF', 'MT', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_renovation_necessity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5369,5369,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_rv_construction_type ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_rv_construction_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4602,4602,'other','andere','autre', 'altro', 'altul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4603,4603,'field','Feld','dans_les_champs', 'campo_aperto', 'in_camp', 'FI', 'FE', 'FE', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4606,4606,'renovation_conduction_excavator','Sanierungsleitung_Bagger','conduite_d_assainissement_retro', 'canalizazzione_risanmento_scavatrice', 'conducte_excavate', 'RCE', 'SBA', 'CAR', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4605,4605,'renovation_conduction_ditch_cutter','Sanierungsleitung_Grabenfraese','conduite_d_assainissement_trancheuse', 'condotta_risanamento_scavafossi', 'conducta_taiere_sant', 'RCD', 'SGF', 'CAT', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4604,4604,'road','Strasse','sous_route', 'strada', 'sub_strada', 'ST', 'ST', 'ST', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_rv_construction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4601,4601,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_status ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_status_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3633,3633,'inoperative','ausser_Betrieb','hors_service', 'fuori_servizio', 'rrr_ausser_Betrieb', 'NO', 'AB', 'H', 'FS', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (8493,8493,'operational','in_Betrieb','en_service', 'in_funzione', 'functionala', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6530,6530,'operational.tentative','in_Betrieb.provisorisch','en_service.provisoire', 'in_funzione.provvisorio', 'functionala.provizoriu', 'T', 'T', 'P', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6533,6533,'operational.will_be_suspended','in_Betrieb.wird_aufgehoben','en_service.sera_supprime', 'in_funzione.da_eliminare', 'functionala.va_fi_eliminata', '', 'WA', 'SS', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6523,6523,'abanndoned.suspended_not_filled','tot.aufgehoben_nicht_verfuellt','abandonne.supprime_non_demoli', 'abbandonato.eliminato_non_demolito', 'abandonata.eliminare_necompletata', 'SN', 'AN', 'S', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6524,6524,'abanndoned.suspended_unknown','tot.aufgehoben_unbekannt','abandonne.supprime_inconnu', 'abbandonato.eliminato_sconosciuto', 'abandonata.demolare_necunoscuta', 'SU', 'AU', 'AI', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6532,6532,'abanndoned.filled','tot.verfuellt','abandonne.demoli', 'abbandonato.demolito', 'abandonata.eliminata', '', 'V', 'D', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3027,3027,'unknown','unbekannt','inconnu', 'sconosciuto', 'rrr_unbekannt', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6526,6526,'other.calculation_alternative','weitere.Berechnungsvariante','autre.variante_de_calcul', 'altri.variante_calcolo', 'alta.varianta_calcul', 'CA', 'B', 'C', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7959,7959,'other.planned','weitere.geplant','autre.planifie', 'altri.previsto', 'rrr_weitere.geplant', '', 'G', 'PL', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6529,6529,'other.project','weitere.Projekt','autre.projet', 'altri.progetto', 'alta.proiect', '', 'N', 'PR', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_structure_condition ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_structure_condition_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3037,3037,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3363,3363,'Z0','Z0','Z0', 'Z0', 'Z0', '', 'Z0', 'Z0', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3359,3359,'Z1','Z1','Z1', 'Z1', 'Z1', '', 'Z1', 'Z1', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3360,3360,'Z2','Z2','Z2', 'Z2', 'Z2', '', 'Z2', 'Z2', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3361,3361,'Z3','Z3','Z3', 'Z3', 'Z3', '', 'Z3', 'Z3', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_structure_condition (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3362,3362,'Z4','Z4','Z4', 'Z4', '', '', 'Z4', 'Z4', '', '', 'true');
...
ALTER TABLE qgep.od_wastewater_structure ADD CONSTRAINT rel_wastewater_structure_owner FOREIGN KEY (fk_owner) REFERENCES qgep.od_organisation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN fk_operator varchar (16);
ALTER TABLE qgep.od_wastewater_structure ADD CONSTRAINT rel_wastewater_structure_operator FOREIGN KEY (fk_operator) REFERENCES qgep.od_organisation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_channel ADD CONSTRAINT oorel_od_channel_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_channel_bedding_encasement ADD CONSTRAINT pkey_qgep_vl_channel_bedding_encasement_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5325,5325,'other','andere','autre', 'altro', 'altul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5332,5332,'in_soil','erdverlegt','enterre', 'zzz_erdverlegt', 'pamant', 'IS', 'EV', 'ET', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5328,5328,'in_channel_suspended','in_Kanal_aufgehaengt','suspendu_dans_le_canal', 'zzz_in_Kanal_aufgehaengt', 'suspendat_in_canal', '', 'IKA', 'CS', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5339,5339,'in_channel_concrete_casted','in_Kanal_einbetoniert','betonne_dans_le_canal', 'zzz_in_Kanal_einbetoniert', 'beton_in_canal', '', 'IKB', 'CB', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5331,5331,'in_walk_in_passage','in_Leitungsgang','en_galerie', 'zzz_in_Leitungsgang', 'galerie', '', 'ILG', 'G', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5337,5337,'in_jacking_pipe_concrete','in_Vortriebsrohr_Beton','en_pousse_tube_en_beton', 'zzz_in_Vortriebsrohr_Beton', 'beton_presstube', '', 'IVB', 'TB', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5336,5336,'in_jacking_pipe_steel','in_Vortriebsrohr_Stahl','en_pousse_tube_en_acier', 'zzz_in_Vortriebsrohr_Stahl', 'otel_presstube', '', 'IVS', 'TA', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5335,5335,'sand','Sand','sable', 'zzz_Sand', 'nisip', '', 'SA', 'SA', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5333,5333,'sia_type_1','SIA_Typ1','SIA_type_1', 'SIA_tippo1', 'SIA_tip_1', '', 'B1', 'B1', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5330,5330,'sia_type_2','SIA_Typ2','SIA_type_2', 'SIA_tippo2', 'SIA_tip_2', '', 'B2', 'B2', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5334,5334,'sia_type_3','SIA_Typ3','SIA_type_3', 'SIA_tippo3', 'SIA_tip_3', '', 'B3', 'B3', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5340,5340,'sia_type_4','SIA_Typ4','SIA_type_4', 'SIA_tippo4', 'SIA_tip_4', '', 'B4', 'B4', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5327,5327,'bed_plank','Sohlbrett','radier_en_planches', 'zzz_Sohlbrett', 'pat_de_pamant', '', 'SB', 'RP', '', '', 'true');
 INSERT INTO qgep.vl_channel_bedding_encasement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5329,5329,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_channel_connection_type ADD CONSTRAINT pkey_qgep_vl_channel_connection_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5341,5341,'other','andere','autre', 'altro', 'altul', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (190,190,'electric_welded_sleeves','Elektroschweissmuffen','manchon_electrosoudable', 'zzz_Elektroschweissmuffen', 'manson_electrosudabil', 'EWS', 'EL', 'MSA', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (187,187,'flat_sleeves','Flachmuffen','manchon_plat', 'zzz_Flachmuffen', 'mason_plat', '', 'FM', 'MP', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (193,193,'flange','Flansch','bride', 'zzz_Flansch', 'flansa', '', 'FL', 'B', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (185,185,'bell_shaped_sleeves','Glockenmuffen','emboitement_a_cloche', 'zzz_Glockenmuffen', 'imbinare_tip_clopot', '', 'GL', 'EC', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (192,192,'coupling','Kupplung','raccord', 'zzz_Kupplung', 'racord', '', 'KU', 'R', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (194,194,'screwed_sleeves','Schraubmuffen','manchon_visse', 'zzz_Schraubmuffen', 'manson_insurubat', '', 'SC', 'MV', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (189,189,'butt_welded','spiegelgeschweisst','manchon_soude_au_miroir', 'zzz_spiegelgeschweisst', 'manson_sudat_cap_la_cap', '', 'SP', 'MSM', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (186,186,'beaked_sleeves','Spitzmuffen','emboitement_simple', 'zzz_Spitzmuffen', 'imbinare_simpla', '', 'SM', 'ES', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (191,191,'push_fit_sleeves','Steckmuffen','raccord_a_serrage', 'zzz_Steckmuffen', 'racord_de_prindere', '', 'ST', 'RS', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (188,188,'slip_on_sleeves','Ueberschiebmuffen','manchon_coulissant', 'zzz_Ueberschiebmuffen', 'manson_culisant', '', 'UE', 'MC', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3036,3036,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_channel_connection_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3666,3666,'jacking_pipe_coupling','Vortriebsrohrkupplung','raccord_pour_tube_de_pousse_tube', 'zzz_Vortriebsrohrkupplung', 'racord_prin_presstube', '', 'VK', 'RTD', '', '', 'true');
...
ALTER TABLE qgep.vl_channel_function_hierarchic ADD CONSTRAINT pkey_qgep_vl_channel_function_hierarchic_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5066,5066,'pwwf.other','PAA.andere','OAP.autre', 'IPS.altro', 'pwwf.alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5068,5068,'pwwf.water_bodies','PAA.Gewaesser','OAP.cours_d_eau', 'IPS.corpo_acqua', 'pwwf.curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5069,5069,'pwwf.main_drain','PAA.Hauptsammelkanal','OAP.collecteur_principal', 'IPS.collettore_principale', 'pwwf.colector_principal', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5070,5070,'pwwf.main_drain_regional','PAA.Hauptsammelkanal_regional','OAP.collecteur_principal_regional', 'IPS.collettore_principale_regionale', 'pwwf.colector_principal_regional', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5064,5064,'pwwf.residential_drainage','PAA.Liegenschaftsentwaesserung','OAP.evacuation_bien_fonds', 'IPS.samltimento_acque_fondi', 'pwwf.evacuare_rezidentiala', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5071,5071,'pwwf.collector_sewer','PAA.Sammelkanal','OAP.collecteur', 'IPS.collettore', 'pwwf.colector', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5062,5062,'pwwf.renovation_conduction','PAA.Sanierungsleitung','OAP.conduite_d_assainissement', 'IPS.condotta_risanamento', 'pwwf.conducta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5072,5072,'pwwf.road_drainage','PAA.Strassenentwaesserung','OAP.evacuation_des_eaux_de_routes', 'IPS.samltimento_acque_stradali', 'pwwf.rigola_drum', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5074,5074,'pwwf.unknown','PAA.unbekannt','OAP.inconnue', 'IPS.sconosciuto', 'pwwf.necunoscuta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5067,5067,'swwf.other','SAA.andere','OAS.autre', 'ISS.altro', 'swwf.alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5065,5065,'swwf.residential_drainage','SAA.Liegenschaftsentwaesserung','OAS.evacuation_bien_fonds', 'ISS.smaltimento_acque_fondi', 'swwf.evacuare_rezidentiala', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5063,5063,'swwf.renovation_conduction','SAA.Sanierungsleitung','OAS.conduite_d_assainissement', 'ISS.condotta_risanamento', 'swwf.racord', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5073,5073,'swwf.road_drainage','SAA.Strassenentwaesserung','OAS.evacuation_des_eaux_de_routes', 'ISS.smaltimento_acque_strade', 'swwf.evacuare_ape_rigole', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hierarchic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5075,5075,'swwf.unknown','SAA.unbekannt','OAS.inconnue', 'ISS.sconosciuto', 'swwf.necunoscuta', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_channel_function_hydraulic ADD CONSTRAINT pkey_qgep_vl_channel_function_hydraulic_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5320,5320,'other','andere','autre', 'altro', 'alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2546,2546,'drainage_transportation_pipe','Drainagetransportleitung','conduite_de_transport_pour_le_drainage', 'condotta_trasporto_drenaggi', 'conducta_transport_dren', 'DTP', 'DT', 'CTD', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (22,22,'restriction_pipe','Drosselleitung','conduite_d_etranglement', 'condotta_strozzamento', 'conducta_redusa', 'RP', 'DR', 'CE', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3610,3610,'inverted_syphon','Duekerleitung','siphon_inverse', 'canalizzazione_sifone', 'sifon_inversat', 'IS', 'DU', 'S', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (367,367,'gravity_pipe','Freispiegelleitung','conduite_a_ecoulement_gravitaire', 'canalizzazione_gravita', 'conducta_gravitationala', '', 'FL', 'CEL', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (23,23,'pump_pressure_pipe','Pumpendruckleitung','conduite_de_refoulement', 'canalizzazione_pompaggio', 'conducta_de_refulare', '', 'DL', 'CR', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (145,145,'seepage_water_drain','Sickerleitung','conduite_de_drainage', 'canalizzazione_drenaggio', 'conducta_drenaj', 'SP', 'SI', 'CI', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (21,21,'retention_pipe','Speicherleitung','conduite_de_retention', 'canalizzazione_ritenzione', 'conducta_de_retentie', '', 'SK', 'CA', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (144,144,'jetting_pipe','Spuelleitung','conduite_de_rincage', 'canalizzazione_spurgo', 'conducta_de_spalare', 'JP', 'SL', 'CC', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5321,5321,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_function_hydraulic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3655,3655,'vacuum_pipe','Vakuumleitung','conduite_sous_vide', 'canalizzazione_sotto_vuoto', 'conducta_vidata', '', 'VL', 'CV', '', '', 'true');
...
ALTER TABLE qgep.vl_channel_usage_current ADD CONSTRAINT pkey_qgep_vl_channel_usage_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5322,5322,'other','andere','autre', 'altro', 'alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4518,4518,'creek_water','Bachwasser','eaux_cours_d_eau', 'acqua_corso_acqua', 'ape_curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4516,4516,'discharged_combined_wastewater','entlastetes_Mischabwasser','eaux_mixtes_deversees', 'acque_miste_scaricate', 'ape_mixte_deversate', 'DCW', 'EW', 'EUD', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4524,4524,'industrial_wastewater','Industrieabwasser','eaux_industrielles', 'acque_industriali', 'ape_industriale', '', 'CW', 'EUC', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4522,4522,'combined_wastewater','Mischabwasser','eaux_mixtes', 'acque_miste', 'ape_mixte', '', 'MW', 'EUM', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4520,4520,'rain_wastewater','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'apa_meteorica', '', 'RW', 'EUP', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4514,4514,'clean_wastewater','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EUR', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4526,4526,'wastewater','Schmutzabwasser','eaux_usees', 'acque_luride', 'ape_uzate', '', 'SW', 'EU', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4571,4571,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_channel_usage_planned ADD CONSTRAINT pkey_qgep_vl_channel_usage_planned_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5323,5323,'other','andere','autre', 'altro', 'alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4519,4519,'creek_water','Bachwasser','eaux_cours_d_eau', 'acqua_corso_acqua', 'ape_curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4517,4517,'discharged_combined_wastewater','entlastetes_Mischabwasser','eaux_mixtes_deversees', 'acque_miste_scaricate', 'ape_mixte_deversate', 'DCW', 'EW', 'EUD', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4525,4525,'industrial_wastewater','Industrieabwasser','eaux_industrielles', 'acque_industriali', 'ape_industriale', '', 'CW', 'EUC', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4523,4523,'combined_wastewater','Mischabwasser','eaux_mixtes', 'acque_miste', 'ape_mixte', '', 'MW', 'EUM', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4521,4521,'rain_wastewater','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'apa_meteorica', '', 'RW', 'EUP', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4515,4515,'clean_wastewater','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EUR', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4527,4527,'wastewater','Schmutzabwasser','eaux_usees', 'acque_luride', 'ape_uzate', '', 'SW', 'EU', '', '', 'true');
 INSERT INTO qgep.vl_channel_usage_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4569,4569,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_manhole ADD CONSTRAINT oorel_od_manhole_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_manhole_function ADD CONSTRAINT pkey_qgep_vl_manhole_function_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4532,4532,'drop_structure','Absturzbauwerk','ouvrage_de_chute', 'manufatto_caduta', 'instalatie_picurare', 'DS', 'AK', 'OC', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5344,5344,'other','andere','autre', 'altro', 'alta', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4533,4533,'venting','Be_Entlueftung','aeration', 'zzz_Be_Entlueftung', 'aerisire', 'VE', 'BE', 'AE', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3267,3267,'rain_water_manhole','Dachwasserschacht','chambre_recolte_eaux_toitures', 'zzz_Dachwasserschacht', 'camin_vizitare_apa_meteorica', 'RWM', 'DS', 'CRT', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3266,3266,'gully','Einlaufschacht','chambre_avec_grille_d_entree', 'zzz_Einlaufschacht', 'gura_scurgere', 'G', 'ES', 'CG', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3472,3472,'drainage_channel','Entwaesserungsrinne','rigole_de_drainage', 'canaletta_drenaggio', 'rigola', '', 'ER', 'RD', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (228,228,'rail_track_gully','Geleiseschacht','evacuation_des_eaux_des_voies_ferrees', 'zzz_Geleiseschacht', 'evacuare_ape_cale_ferata', '', 'GL', 'EVF', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (204,204,'manhole','Kontrollschacht','regard_de_visite', 'pozzetto_ispezione', 'camin_vizitare', '', 'KS', 'CC', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (1008,1008,'oil_separator','Oelabscheider','separateur_d_hydrocarbures', 'separatore_olii', 'separator_hidrocarburi', 'OS', 'OA', 'SH', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4536,4536,'pump_station','Pumpwerk','station_de_pompage', 'stazione_pompaggio', 'statie_pompare', '', 'PW', 'SP', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5346,5346,'stormwater_overflow','Regenueberlauf','deversoir_d_orage', 'scaricatore_piena', 'preaplin', '', 'HE', 'DO', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2742,2742,'slurry_collector','Schlammsammler','depotoir', 'pozzetto_decantazione', 'colector_aluviuni', '', 'SA', 'D', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5347,5347,'floating_material_separator','Schwimmstoffabscheider','separateur_de_materiaux_flottants', 'separatore_materiali_galleggianti', 'separator_materie_flotanta', '', 'SW', 'SMF', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4537,4537,'jetting_manhole','Spuelschacht','chambre_de_chasse', 'pozzetto_lavaggio', 'camin_spalare', '', 'SS', 'CC', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4798,4798,'separating_structure','Trennbauwerk','ouvrage_de_repartition', 'camera_ripartizione', 'separator', '', 'TB', 'OR', '', '', 'true');
 INSERT INTO qgep.vl_manhole_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5345,5345,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_manhole_material ADD CONSTRAINT pkey_qgep_vl_manhole_material_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_manhole_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4540,4540,'other','andere','autre', 'altro', 'altul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_manhole_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4541,4541,'concrete','Beton','beton', 'zzz_Beton', 'beton', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_manhole_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4542,4542,'plastic','Kunststoff','matiere_plastique', 'zzz_Kunststoff', 'materie_plastica', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_manhole_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4543,4543,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_manhole_surface_inflow ADD CONSTRAINT pkey_qgep_vl_manhole_surface_inflow_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_manhole_surface_inflow (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5342,5342,'other','andere','autre', 'altro', 'altul', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_manhole_surface_inflow (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2741,2741,'none','keiner','aucune', 'nessuno', 'niciunul', '', 'K', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_manhole_surface_inflow (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2739,2739,'grid','Rost','grille_d_ecoulement', 'zzz_Rost', 'grilaj', '', 'R', 'G', '', '', 'true');
 INSERT INTO qgep.vl_manhole_surface_inflow (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5343,5343,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_manhole_surface_inflow (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2740,2740,'intake_from_side','Zulauf_seitlich','arrivee_laterale', 'zzz_Zulauf_seitlich', 'admisie_laterala', '', 'ZS', 'AL', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_discharge_point ADD CONSTRAINT oorel_od_discharge_point_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_discharge_point_relevance ADD CONSTRAINT pkey_qgep_vl_discharge_point_relevance_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_discharge_point_relevance (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5580,5580,'relevant_for_water_course','gewaesserrelevant','pertinent_pour_milieu_recepteur', 'zzz_gewaesserrelevant', 'relevanta_pentru_mediul_receptor', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_discharge_point_relevance (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5581,5581,'non_relevant_for_water_course','nicht_gewaesserrelevant','insignifiant_pour_milieu_recepteur', 'zzz_nicht_gewaesserrelevant', 'nerelevanta_pentru_mediul_receptor', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_special_structure ADD CONSTRAINT oorel_od_special_structure_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_special_structure_bypass ADD CONSTRAINT pkey_qgep_vl_special_structure_bypass_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_special_structure_bypass (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2682,2682,'inexistent','nicht_vorhanden','inexistant', 'zzz_nicht_vorhanden', 'inexistent', '', 'NV', 'IE', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_bypass (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3055,3055,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_bypass (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2681,2681,'existent','vorhanden','existant', 'zzz_vorhanden', 'existent', '', 'V', 'E', '', '', 'true');
...
ALTER TABLE qgep.vl_special_structure_emergency_spillway ADD CONSTRAINT pkey_qgep_vl_special_structure_emergency_spillway_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5866,5866,'other','andere','autres', 'altri', 'altele', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5864,5864,'in_combined_waste_water_drain','inMischabwasserkanalisation','dans_canalisation_eaux_mixtes', 'in_canalizzazione_acque_miste', 'in_canalizare_apa_mixta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5865,5865,'in_rain_waste_water_drain','inRegenabwasserkanalisation','dans_canalisation_eaux_pluviales', 'in_canalizzazione_acque_meteoriche', 'in_canalizare_apa_meteorica', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5863,5863,'in_waste_water_drain','inSchmutzabwasserkanalisation','dans_canalisation_eaux_usees', 'in_canalizzazione_acque_luride', 'in_canalizare_apa_uzata', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5878,5878,'none','keiner','aucun', 'nessuno', 'niciunul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5867,5867,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_special_structure_function ADD CONSTRAINT pkey_qgep_vl_special_structure_function_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6397,6397,'pit_without_drain','abflussloseGrube','fosse_etanche', 'zzz_abflussloseGrube', 'bazin_vidanjabil', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (245,245,'drop_structure','Absturzbauwerk','ouvrage_de_chute', 'manufatto_caduta', 'instalatie_picurare', 'DS', 'AK', 'OC', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6398,6398,'hydrolizing_tank','Abwasserfaulraum','fosse_digestive', 'zzz_Abwasserfaulraum', 'fosa_hidroliza', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5371,5371,'other','andere','autre', 'altro', 'alta', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (386,386,'venting','Be_Entlueftung','aeration', 'zzz_Be_Entlueftung', 'aerisire', 'VE', 'BE', 'AE', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3234,3234,'inverse_syphon_chamber','Duekerkammer','chambre_avec_siphon_inverse', 'zzz_Duekerkammer', 'instalatie_cu_sifon_inversat', 'ISC', 'DK', 'SI', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5091,5091,'syphon_head','Duekeroberhaupt','entree_de_siphon', 'zzz_Duekeroberhaupt', 'cap_sifon', 'SH', 'DO', 'ESI', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6399,6399,'septic_tank_two_chambers','Faulgrube','fosse_septique', 'zzz_Faulgrube', 'fosa_septica_2_compartimente', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3348,3348,'terrain_depression','Gelaendemulde','depression_de_terrain', 'zzz_Gelaendemulde', 'depresiune_teren', '', 'GM', 'DT', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (336,336,'bolders_bedload_catchement_dam','Geschiebefang','depotoir_pour_alluvions', 'camera_ritenuta', 'colector_aluviuni', '', 'GF', 'DA', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5494,5494,'cesspit','Guellegrube','fosse_a_purin', 'zzz_Guellegrube', 'hazna', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6478,6478,'septic_tank','Klaergrube','fosse_de_decantation', 'fossa_settica', 'fosa_septica', '', 'KG', 'FD', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2998,2998,'manhole','Kontrollschacht','regard_de_visite', 'pozzetto_ispezione', 'camin_vizitare', '', 'KS', 'RV', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2768,2768,'oil_separator','Oelabscheider','separateur_d_hydrocarbures', 'separatore_olii', 'separator_hidrocarburi', '', 'OA', 'SH', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (246,246,'pump_station','Pumpwerk','station_de_pompage', 'stazione_pompaggio', 'statie_pompare', '', 'PW', 'SP', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3673,3673,'stormwater_tank_with_overflow','Regenbecken_Durchlaufbecken','BEP_decantation', 'zzz_Regenbecken_Durchlaufbecken', 'bazin_retentie_apa_meteorica_cu_preaplin', '', 'DB', 'BDE', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3674,3674,'stormwater_tank_retaining_first_flush','Regenbecken_Fangbecken','BEP_retention', 'bacino_accumulo', 'bazin_retentie_apa_meteorica_prima_spalare', '', 'FB', 'BRE', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5574,5574,'stormwater_retaining_channel','Regenbecken_Fangkanal','BEP_canal_retention', 'canale_accumulo', 'bazin_retentie', 'TRE', 'FK', 'BCR', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3675,3675,'stormwater_sedimentation_tank','Regenbecken_Regenklaerbecken','BEP_clarification', 'bacino_decantazione_acque_meteoriche', 'bazin_decantare', '', 'RKB', 'BCL', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3676,3676,'stormwater_retention_tank','Regenbecken_Regenrueckhaltebecken','BEP_accumulation', 'bacino_ritenzione', 'bazin_retentie_apa_meteorica', '', 'RRB', 'BAC', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5575,5575,'stormwater_retention_channel','Regenbecken_Regenrueckhaltekanal','BEP_canal_accumulation', 'canale_ritenzione', 'canal_retentie_apa_meteorica', 'TRC', 'RRK', 'BCA', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5576,5576,'stormwater_storage_channel','Regenbecken_Stauraumkanal','BEP_canal_stockage', 'canale_stoccaggio', 'bazin_stocare', 'TSC', 'SRK', 'BCS', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3677,3677,'stormwater_composite_tank','Regenbecken_Verbundbecken','BEP_combine', 'bacino_combinato', '', '', 'VB', 'BCO', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5372,5372,'stormwater_overflow','Regenueberlauf','deversoir_d_orage', 'scaricatore_piena', 'preaplin', '', 'RU', 'DO', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5373,5373,'floating_material_separator','Schwimmstoffabscheider','separateur_de_materiaux_flottants', 'separatore_materiali_galleggianti', 'separator_materie_flotanta', '', 'SW', 'SMF', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (383,383,'side_access','seitlicherZugang','acces_lateral', 'zzz_seitlicherZugang', 'acces_lateral', '', 'SZ', 'AL', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (227,227,'jetting_manhole','Spuelschacht','chambre_de_chasse', 'pozzetto_lavaggio', 'camin_spalare', '', 'SS', 'CC', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4799,4799,'separating_structure','Trennbauwerk','ouvrage_de_repartition', 'camera_ripartizione', 'separator', '', 'TB', 'OR', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3008,3008,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2745,2745,'vortex_manhole','Wirbelfallschacht','chambre_de_chute_a_vortex', 'zzz_Wirbelfallschacht', 'instalatie_picurare_cu_vortex', '', 'WF', 'CT', '', '', 'true');
...
ALTER TABLE qgep.vl_special_structure_stormwater_tank_arrangement ADD CONSTRAINT pkey_qgep_vl_special_structure_stormwater_tank_arrangement_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_special_structure_stormwater_tank_arrangement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4608,4608,'main_connection','Hauptschluss','connexion_directe', 'in_serie', 'conectare_directa', '', 'HS', 'CD', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_stormwater_tank_arrangement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4609,4609,'side_connection','Nebenschluss','connexion_laterale', 'in_parallelo', 'conectare_laterala', '', 'NS', 'CL', '', '', 'true');
 INSERT INTO qgep.vl_special_structure_stormwater_tank_arrangement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4610,4610,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_infiltration_installation ADD CONSTRAINT oorel_od_infiltration_installation_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_infiltration_installation_defects ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_defects_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_defects (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5361,5361,'none','keine','aucunes', 'nessuno', 'inexistente', '', 'K', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_defects (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3276,3276,'marginal','unwesentliche','modestes', 'zzz_unwesentliche', 'modeste', '', 'UW', 'MI', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_defects (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3275,3275,'substantial','wesentliche','importantes', 'zzz_wesentliche', 'importante', '', 'W', 'MA', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_emergency_spillway ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_emergency_spillway_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5365,5365,'in_combined_waste_water_drain','inMischwasserkanalisation','dans_canalisation_eaux_mixtes', 'zzz_inMischwasserkanalisation', 'in_canalizare_ape_mixte', '', 'IMK', 'CEM', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3307,3307,'in_rain_waste_water_drain','inRegenwasserkanalisation','dans_canalisation_eaux_pluviales', 'zzz_inRegenwasserkanalisation', 'in_canalizare_apa_meteorica', '', 'IRK', 'CEP', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3304,3304,'in_water_body','inVorfluter','au_cours_d_eau_recepteur', 'zzz_inVorfluter', 'in_curs_apa', '', 'IV', 'CE', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3303,3303,'none','keiner','aucun', 'nessuno', 'inexistent', '', 'K', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3305,3305,'surface_discharge','oberflaechlichausmuendend','deversement_en_surface', 'zzz_oberflaechlichausmuendend', 'deversare_la_suprafata', '', 'OA', 'DS', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_emergency_spillway (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3308,3308,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_kind ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3282,3282,'with_soil_passage','andere_mit_Bodenpassage','autre_avec_passage_a_travers_sol', 'zzz_altri_mit_Bodenpassage', 'altul_cu_traversare_sol', 'WSP', 'AMB', 'APC', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3285,3285,'without_soil_passage','andere_ohne_Bodenpassage','autre_sans_passage_a_travers_sol', 'zzz_altri_ohne_Bodenpassage', 'altul_fara_traversare_sol', 'WOP', 'AOB', 'ASC', '', '', 'true');
 ...
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (277,277,'gravel_formation','Kieskoerper','corps_de_gravier', 'zzz_Kieskoerper', 'formatiune_de_pietris', '', 'KK', 'VG', '', '', 'true');
 ...
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3087,3087,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 ...
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (276,276,'infiltration_basin','Versickerungsbecken','bassin_d_infiltration', 'zzz_Versickerungsbecken', 'bazin_infiltrare', '', 'VB', 'BI', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (278,278,'adsorbing_well','Versickerungsschacht','puits_d_infiltration', 'zzz_Versickerungsschacht', 'put_de_inflitrare', '', 'VS', 'PI', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_labeling ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_labeling_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_labeling (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5362,5362,'labeled','beschriftet','signalee', 'zzz_beschriftet', 'marcat', 'L', 'BS', 'SI', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_labeling (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5363,5363,'not_labeled','nichtbeschriftet','non_signalee', 'zzz_nichtbeschriftet', 'nemarcat', '', 'NBS', 'NSI', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_labeling (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5364,5364,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_seepage_utilization ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_seepage_utilization_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_seepage_utilization (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (274,274,'rain_water','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'ape_pluviale', '', 'RW', 'EP', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_seepage_utilization (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (273,273,'clean_water','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EC', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_seepage_utilization (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5359,5359,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_vehicle_access ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_vehicle_access_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_vehicle_access (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3289,3289,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_vehicle_access (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3288,3288,'inaccessible','unzugaenglich','inaccessible', 'non_accessibile', 'neaccesibil', '', 'ZU', 'IAC', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_vehicle_access (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3287,3287,'accessible','zugaenglich','accessible', 'accessibile', 'accessibil', '', 'Z', 'AC', '', '', 'true');
...
ALTER TABLE qgep.vl_infiltration_installation_watertightness ADD CONSTRAINT pkey_qgep_vl_infiltration_installation_watertightness_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_installation_watertightness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3295,3295,'not_watertight','nichtwasserdicht','non_etanche', 'zzz_nichtwasserdicht', 'neetans', '', 'NWD', 'NE', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_watertightness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5360,5360,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_installation_watertightness (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3294,3294,'watertight','wasserdicht','etanche', 'zzz_wasserdicht', 'etans', '', 'WD', 'E', '', '', 'true');
...
ALTER TABLE qgep.od_wwtp_structure ADD CONSTRAINT oorel_od_wwtp_structure_wastewater_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_wwtp_structure_kind ADD CONSTRAINT pkey_qgep_vl_wwtp_structure_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (331,331,'sedimentation_basin','Absetzbecken','bassin_de_decantation', 'zzz_Absetzbecken', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2974,2974,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (327,327,'aeration_tank','Belebtschlammbecken','bassin_a_boues_activees', 'zzz_Belebtschlammbecken', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (329,329,'fixed_bed_reactor','Festbettreaktor','reacteur_a_biomasse_fixee', 'zzz_Festbettreaktor', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (330,330,'submerged_trickling_filter','Tauchtropfkoerper','disque_bacterien_immerge', 'zzz_Tauchtropfkoerper', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (328,328,'trickling_filter','Tropfkoerper','lit_bacterien', 'zzz_Tropfkoerper', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3032,3032,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wwtp_structure_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (326,326,'primary_clarifier','Vorklaerbecken','decanteurs_primaires', 'zzz_Vorklaerbecken', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_maintenance_event_kind ADD CONSTRAINT pkey_qgep_vl_maintenance_event_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2982,2982,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (120,120,'replacement','Erneuerung','renouvellement', 'zzz_Erneuerung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (28,28,'cleaning','Reinigung','nettoyage', 'zzz_Reinigung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4529,4529,'renovation','Renovierung','renovation', 'zzz_Renovierung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4528,4528,'repair','Reparatur','reparation', 'zzz_Reparatur', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4530,4530,'restoration','Sanierung','rehabilitation', 'zzz_Sanierung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3045,3045,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4564,4564,'examination','Untersuchung','examen', 'zzz_Untersuchung', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_maintenance_event_status ADD CONSTRAINT pkey_qgep_vl_maintenance_event_status_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_maintenance_event_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2550,2550,'accomplished','ausgefuehrt','execute', 'zzz_ausgefuehrt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2549,2549,'planned','geplant','prevu', 'previsto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3678,3678,'not_possible','nicht_moeglich','impossible', 'zzz_nicht_moeglich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_maintenance_event_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3047,3047,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_maintenance_event ADD COLUMN fk_operating_company varchar (16);
ALTER TABLE qgep.od_maintenance_event ADD CONSTRAINT rel_maintenance_event_operating_company FOREIGN KEY (fk_operating_company) REFERENCES qgep.od_organisation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_planning_zone ADD CONSTRAINT oorel_od_planning_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_planning_zone_kind ADD CONSTRAINT pkey_qgep_vl_planning_zone_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2990,2990,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (31,31,'commercial_zone','Gewerbezone','zone_artisanale', 'zzz_Gewerbezone', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (32,32,'industrial_zone','Industriezone','zone_industrielle', 'zzz_Industriezone', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (30,30,'agricultural_zone','Landwirtschaftszone','zone_agricole', 'zzz_Landwirtschaftszone', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3077,3077,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_planning_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (29,29,'residential_zone','Wohnzone','zone_d_habitations', 'zzz_Wohnzone', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_infiltration_zone ADD CONSTRAINT oorel_od_infiltration_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_infiltration_zone_infiltration_capacity ADD CONSTRAINT pkey_qgep_vl_infiltration_zone_infiltration_capacity_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (371,371,'good','gut','bonnes', 'zzz_gut', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (374,374,'none','keine','aucune', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (372,372,'moderate','maessig','moyennes', 'zzz_maessig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (373,373,'bad','schlecht','mauvaises', 'zzz_schlecht', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3073,3073,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_infiltration_zone_infiltration_capacity (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2996,2996,'not_allowed','unzulaessig','non_admis', 'zzz_unzulaessig', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_drainage_system ADD CONSTRAINT oorel_od_drainage_system_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_drainage_system_kind ADD CONSTRAINT pkey_qgep_vl_drainage_system_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4783,4783,'amelioration','Melioration','melioration', 'zzz_Melioration', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2722,2722,'mixed_system','Mischsystem','systeme_unitaire', 'sistema_misto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2724,2724,'modified_system','ModifiziertesSystem','systeme_modifie', 'sistema_modificato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4544,4544,'not_connected','nicht_angeschlossen','non_raccorde', 'non_collegato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2723,2723,'separated_system','Trennsystem','systeme_separatif', 'sistema_separato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_drainage_system_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3060,3060,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_water_body_protection_sector ADD CONSTRAINT oorel_od_water_body_protection_sector_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_water_body_protection_sector_kind ADD CONSTRAINT pkey_qgep_vl_water_body_protection_sector_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (430,430,'A','A','A', 'A', 'A', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3652,3652,'Ao','Ao','Ao', 'zzz_Ao', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3649,3649,'Au','Au','Au', 'zzz_Au', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (431,431,'B','B','B', 'B', 'B', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (432,432,'C','C','C', 'C', 'C', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3069,3069,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3651,3651,'Zo','Zo','Zo', 'zzz_Zo', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_water_body_protection_sector_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3650,3650,'Zu','Zu','Zu', 'zzz_Zu', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_ground_water_protection_perimeter ADD CONSTRAINT oorel_od_ground_water_protection_perimeter_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_groundwater_protection_zone ADD CONSTRAINT oorel_od_groundwater_protection_zone_zone FOREIGN KEY (obj_id) REFERENCES qgep.od_zone(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_groundwater_protection_zone_kind ADD CONSTRAINT pkey_qgep_vl_groundwater_protection_zone_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_groundwater_protection_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (440,440,'S1','S1','S1', 'S1', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_groundwater_protection_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (441,441,'S2','S2','S2', 'S2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_groundwater_protection_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (442,442,'S3','S3','S3', 'S3', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_groundwater_protection_zone_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3040,3040,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_pipe_profile_profile_type ADD CONSTRAINT pkey_qgep_vl_pipe_profile_profile_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3351,3351,'egg','Eiprofil','ovoide', 'ovoidale', 'ovoid', 'E', 'E', 'OV', '', '', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3350,3350,'circle','Kreisprofil','circulaire', 'cicolare', 'rotund', 'CI', 'K', 'CI', 'CI', 'R', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3352,3352,'mouth','Maulprofil','profil_en_voute', 'composto', 'sectiune_cu_bolta', 'M', 'M', 'V', 'C', '', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3354,3354,'open','offenes_Profil','profil_ouvert', 'sezione_aperta', 'profil_deschis', 'OP', 'OP', 'PO', 'SA', '', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3353,3353,'rectangular','Rechteckprofil','rectangulaire', 'rettangolare', 'dreptunghiular', 'R', 'R', 'R', 'R', 'D', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3355,3355,'special','Spezialprofil','profil_special', 'sezione_speciale', 'sectiune_speciala', 'S', 'S', 'PS', 'S', 'S', 'true');
 INSERT INTO qgep.vl_pipe_profile_profile_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3357,3357,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', 'U', 'U', 'I', 'S', 'N', 'true');
...
ALTER TABLE qgep.vl_waste_water_treatment_kind ADD CONSTRAINT pkey_qgep_vl_waste_water_treatment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3210,3210,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (387,387,'biological','biologisch','biologique', 'zzz_biologisch', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (388,388,'chemical','chemisch','chimique', 'zzz_chemisch', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (389,389,'filtration','Filtration','filtration', 'zzz_Filtration', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (366,366,'mechanical','mechanisch','mecanique', 'zzz_mechanisch', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_waste_water_treatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3076,3076,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_sludge_treatment_stabilisation ADD CONSTRAINT pkey_qgep_vl_sludge_treatment_stabilisation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (141,141,'aerob_cold','aerobkalt','aerobie_froid', 'zzz_aerobkalt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (332,332,'aerobthermophil','aerobthermophil','aerobie_thermophile', 'zzz_aerobthermophil', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (333,333,'anaerob_cold','anaerobkalt','anaerobie_froid', 'zzz_anaerobkalt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (334,334,'anaerob_mesophil','anaerobmesophil','anaerobie_mesophile', 'zzz_anaerobmesophil', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (335,335,'anaerob_thermophil','anaerobthermophil','anaerobie_thermophile', 'zzz_anaerobthermophil', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2994,2994,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_sludge_treatment_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3004,3004,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_ford ADD CONSTRAINT oorel_od_ford_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_chute ADD CONSTRAINT oorel_od_chute_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_chute_kind ADD CONSTRAINT pkey_qgep_vl_chute_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_chute_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3591,3591,'artificial','kuenstlich','artificiel', 'zzz_kuenstlich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3592,3592,'natural','natuerlich','naturel', 'zzz_natuerlich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3593,3593,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_chute_material ADD CONSTRAINT pkey_qgep_vl_chute_material_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2633,2633,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (409,409,'concrete_or_rock_pavement','Beton_Steinpflaesterung','beton_pavage_de_pierres', 'zzz_Beton_Steinpflaesterung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (411,411,'rocks_or_boulders','Fels_Steinbloecke','rocher_blocs_de_rocher', 'zzz_Fels_Steinbloecke', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (408,408,'wood','Holz','bois', 'zzz_Holz', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (410,410,'natural_none','natuerlich_kein','naturel_aucun', 'zzz_natuerlich_kein', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_chute_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3061,3061,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_lock ADD CONSTRAINT oorel_od_lock_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_passage ADD CONSTRAINT oorel_od_passage_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_blocking_debris ADD CONSTRAINT oorel_od_blocking_debris_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_dam ADD CONSTRAINT oorel_od_dam_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_dam_kind ADD CONSTRAINT pkey_qgep_vl_dam_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_dam_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (416,416,'retaining_weir','Stauwehr','digue_reservoir', 'zzz_Stauwehr', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_dam_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (417,417,'spillway','Streichwehr','deversoir_lateral', 'sfioratore_laterale', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_dam_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (419,419,'dam','Talsperre','barrage', 'zzz_Talsperre', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_dam_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (418,418,'tyrolean_weir','Tirolerwehr','prise_tyrolienne', 'zzz_Tirolerwehr', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_dam_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3064,3064,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_dam ADD CONSTRAINT fkey_vl_dam_kind FOREIGN KEY (kind)
 REFERENCES qgep.vl_dam_kind (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_rock_ramp ADD CONSTRAINT oorel_od_rock_ramp_water_control_structure FOREIGN KEY (obj_id) REFERENCES qgep.od_water_control_structure(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_rock_ramp_stabilisation ADD CONSTRAINT pkey_qgep_vl_rock_ramp_stabilisation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2635,2635,'other_smooth','andere_glatt','autres_lisse', 'zzz_altri_glatt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2634,2634,'other_rough','andere_rauh','autres_rugueux', 'zzz_altri_rauh', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (415,415,'concrete_channel','Betonrinne','lit_en_beton', 'zzz_Betonrinne', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (412,412,'rocks_or_boulders','Blockwurf','enrochement', 'zzz_Blockwurf', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (413,413,'paved','gepflaestert','pavement', 'zzz_gepflaestert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (414,414,'wooden_beam','Holzbalken','poutres_en_bois', 'zzz_Holzbalken', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_rock_ramp_stabilisation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3063,3063,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_point_elevation_accuracy ADD CONSTRAINT pkey_qgep_vl_reach_point_elevation_accuracy_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_point_elevation_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3248,3248,'more_than_6cm','groesser_6cm','plusque_6cm', 'piu_6cm', 'mai_mare_6cm', '', 'G06', 'S06', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_elevation_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3245,3245,'plusminus_1cm','plusminus_1cm','plus_moins_1cm', 'piu_meno_1cm', 'plus_minus_1cm', '', 'P01', 'P01', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_elevation_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3246,3246,'plusminus_3cm','plusminus_3cm','plus_moins_3cm', 'piu_meno_3cm', 'plus_minus_3cm', '', 'P03', 'P03', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_elevation_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3247,3247,'plusminus_6cm','plusminus_6cm','plus_moins_6cm', 'piu_meno_6cm', 'plus_minus_6cm', '', 'P06', 'P06', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_elevation_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5376,5376,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_point_outlet_shape ADD CONSTRAINT pkey_qgep_vl_reach_point_outlet_shape_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_point_outlet_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5374,5374,'round_edged','abgerundet','arrondie', 'zzz_abgerundet', 'rotunjita', 'RE', 'AR', 'AR', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_outlet_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (298,298,'orifice','blendenfoermig','en_forme_de_seuil_ou_diaphragme', 'zzz_blendenfoermig', 'orificiu', 'O', 'BF', 'FSD', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_outlet_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3358,3358,'no_cross_section_change','keine_Querschnittsaenderung','pas_de_changement_de_section', 'zzz_keine_Querschnittsaenderung', 'fara_schimbare_sectiune', '', 'KQ', 'PCS', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_outlet_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (286,286,'sharp_edged','scharfkantig','aretes_vives', 'zzz_scharfkantig', 'margini_ascutite', '', 'SK', 'AV', '', '', 'true');
 INSERT INTO qgep.vl_reach_point_outlet_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5375,5375,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.od_wastewater_node ADD CONSTRAINT oorel_od_wastewater_node_wastewater_networkelement FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_networkelement(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.od_reach ADD CONSTRAINT oorel_od_reach_wastewater_networkelement FOREIGN KEY (obj_id) REFERENCES qgep.od_wastewater_networkelement(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_reach_elevation_determination ADD CONSTRAINT pkey_qgep_vl_reach_elevation_determination_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_elevation_determination (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4780,4780,'accurate','genau','precise', 'precisa', 'precisa', '', 'LG', 'P', '', '', 'true');
 INSERT INTO qgep.vl_reach_elevation_determination (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4778,4778,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_reach_elevation_determination (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4779,4779,'inaccurate','ungenau','imprecise', 'impreciso', 'imprecisa', '', 'LU', 'IP', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_horizontal_positioning ADD CONSTRAINT pkey_qgep_vl_reach_horizontal_positioning_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_horizontal_positioning (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5378,5378,'accurate','genau','precise', 'precisa', 'precisa', '', 'LG', 'P', '', '', 'true');
 INSERT INTO qgep.vl_reach_horizontal_positioning (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5379,5379,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_reach_horizontal_positioning (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5380,5380,'inaccurate','ungenau','imprecise', 'impreciso', 'imprecisa', '', 'LU', 'IP', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_inside_coating ADD CONSTRAINT pkey_qgep_vl_reach_inside_coating_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5383,5383,'other','andere','autre', 'altro', 'alta', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (248,248,'coating','Anstrich_Beschichtung','peinture_revetement', 'zzz_Anstrich_Beschichtung', 'strat_vopsea', 'C', 'B', 'PR', '', '', 'true');
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (250,250,'brick_lining','Kanalklinkerauskleidung','revetement_en_brique', 'zzz_Kanalklinkerauskleidung', 'strat_caramida', '', 'KL', 'RB', '', '', 'true');
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (251,251,'stoneware_lining','Steinzeugauskleidung','revetement_en_gres', 'zzz_Steinzeugauskleidung', 'strat_gresie', '', 'ST', 'RG', '', '', 'true');
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5384,5384,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_reach_inside_coating (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (249,249,'cement_mortar_lining','Zementmoertelauskleidung','revetement_en_mortier_de_ciment', 'zzz_Zementmoertelauskleidung', 'strat_mortar_ciment', '', 'ZM', 'RM', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_material ADD CONSTRAINT pkey_qgep_vl_reach_material_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5381,5381,'other','andere','autre', 'altro', 'alta', 'O', 'A', 'AU', 'A', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2754,2754,'asbestos_cement','Asbestzement','amiante_ciment', 'cemento_amianto', 'azbociment', 'AC', 'AZ', 'AC', 'CA', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3638,3638,'concrete_normal','Beton_Normalbeton','beton_normal', 'calcestruzzo_normale', 'beton_normal', 'CN', 'NB', 'BN', 'CN', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3639,3639,'concrete_insitu','Beton_Ortsbeton','beton_coule_sur_place', 'calcestruzzo_gettato_opera', 'beton_turnat_insitu', 'CI', 'OB', 'BCP', 'CGO', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3640,3640,'concrete_presspipe','Beton_Pressrohrbeton','beton_pousse_tube', 'calcestruzzo_spingitubo', 'beton_presstube', 'CP', 'PRB', 'BPT', 'CST', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3641,3641,'concrete_special','Beton_Spezialbeton','beton_special', 'calcestruzzo_speciale', 'beton_special', 'CS', 'SB', 'BS', 'CS', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3256,3256,'concrete_unknown','Beton_unbekannt','beton_inconnu', 'calcestruzzo_sconosciuto', 'beton_necunoscut', 'CU', 'BU', 'BI', 'CSC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (147,147,'fiber_cement','Faserzement','fibrociment', 'fibrocemento', 'fibrociment', 'FC', 'FZ', 'FC', 'FC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2755,2755,'bricks','Gebrannte_Steine','terre_cuite', 'ceramica', 'teracota', 'BR', 'SG', 'TC', 'CE', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (148,148,'cast_ductile_iron','Guss_duktil','fonte_ductile', 'ghisa_duttile', 'fonta_ductila', 'ID', 'GD', 'FD', 'GD', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3648,3648,'cast_gray_iron','Guss_Grauguss','fonte_grise', 'ghisa_grigia', 'fonta_cenusie', 'CGI', 'GG', 'FG', 'GG', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5076,5076,'plastic_epoxy_resin','Kunststoff_Epoxydharz','matiere_synthetique_resine_d_epoxy', 'materiale_sintetico_resina_epossidica', 'plastic_rasina_epoxi', 'PER', 'EP', 'EP', 'MSR', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5077,5077,'plastic_highdensity_polyethylene','Kunststoff_Hartpolyethylen','matiere_synthetique_polyethylene_dur', 'materiale_sintetico_polietilene_duro', 'plastic_PEHD', 'HPE', 'HPE', 'PD', 'MSP', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5078,5078,'plastic_polyester_GUP','Kunststoff_Polyester_GUP','matiere_synthetique_polyester_GUP', 'materiale_sintetico_poliestere_GUP', 'plastic_poliester_GUP', 'GUP', 'GUP', 'GUP', 'GUP', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5079,5079,'plastic_polyethylene','Kunststoff_Polyethylen','matiere_synthetique_polyethylene', 'materiale_sintetico_polietilene', 'plastic_PE', 'PE', 'PE', 'PE', 'PE', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5080,5080,'plastic_polypropylene','Kunststoff_Polypropylen','matiere_synthetique_polypropylene', 'materiale_sintetico_polipropilene', 'plastic_polipropilena', 'PP', 'PP', 'PP', 'PP', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5081,5081,'plastic_PVC','Kunststoff_Polyvinilchlorid','matiere_synthetique_PVC', 'materiale_sintetico_PVC', 'plastic_PVC', 'PVC', 'PVC', 'PVC', 'PVC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5382,5382,'plastic_unknown','Kunststoff_unbekannt','matiere_synthetique_inconnue', 'materiale_sintetico_sconosciuto', 'plastic_necunoscut', 'PU', 'KUU', 'MSI', 'MSC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (153,153,'steel','Stahl','acier', 'acciaio', 'otel', 'ST', 'ST', 'AC', 'AC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3654,3654,'steel_stainless','Stahl_rostfrei','acier_inoxydable', 'acciaio_inossidabile', 'inox', 'SST', 'STI', 'ACI', 'ACI', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (154,154,'stoneware','Steinzeug','gres', 'gres', 'gresie', 'SW', 'STZ', 'GR', 'GR', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2761,2761,'clay','Ton','argile', 'argilla', 'argila', 'CL', 'T', 'AR', 'AR', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3016,3016,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', 'U', 'U', 'I', 'SC', '', 'true');
 INSERT INTO qgep.vl_reach_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2762,2762,'cement','Zement','ciment', 'cemento', 'ciment', 'C', 'Z', 'C', 'C', '', 'true');
...
ALTER TABLE qgep.vl_reach_reliner_material ADD CONSTRAINT pkey_qgep_vl_reach_reliner_material_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_reach_reliner_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6483,6483,'GUP_pipe','GUP_Rohr','tuyau_PRV', 'zzz_GUP_Rohr', 'conducta_PAFS', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_reliner_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6462,6462,'HDPE','HDPE','HDPE', 'HDPE', 'PEHD', '', '', '', '', '', 'true');
 ...
 INSERT INTO qgep.vl_reach_reliner_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6482,6482,'polypropylene','Polypropylen','polypropylene', 'polipropilene', 'polipropilena', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_reliner_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6465,6465,'PVC','Polyvinilchlorid','PVC', 'zzz_Polyvinilchlorid', 'PVC', '', '', '', '', '', 'true');
 ...
 INSERT INTO qgep.vl_reach_reliner_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6467,6467,'unknown','unbekannt','inconnu', 'zzz_unbekannt', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_relining_construction ADD CONSTRAINT pkey_qgep_vl_reach_relining_construction_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6448,6448,'other','andere','autre', 'zzz_andere', 'alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6479,6479,'close_fit_relining','Close_Fit_Relining','close_fit_relining', 'zzz_Close_Fit_Relining', 'reconditionare_close_fit', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6449,6449,'relining_short_tube','Kurzrohrrelining','relining_tube_court', 'zzz_Kurzrohrrelining', 'reconditionare_tub_scurt', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6481,6481,'grouted_in_place_lining','Noppenschlauchrelining','Noppenschlauchrelining', 'zzz_Noppenschlauchrelining', 'chituire', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6452,6452,'partial_liner','Partieller_Liner','liner_partiel', 'zzz_Partieller_Liner', 'captuseala_partiala', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6450,6450,'pipe_string_relining','Rohrstrangrelining','chemisage_par_ligne_de_tuyau', 'zzz_Rohrstrangrelining', 'pipe_string_relining', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6451,6451,'hose_relining','Schlauchrelining','chemisage_par_gainage', 'zzz_Schlauchrelining', 'reconditionare_prin_camasuire', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6453,6453,'unknown','unbekannt','inconnu', 'zzz_unbekannt', 'necunoscuta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_construction (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6480,6480,'spiral_lining','Wickelrohrrelining','chemisage_par_tube_spirale', 'zzz_Wickelrohrrelining', 'captusire_prin_tub_spirala', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_relining_kind ADD CONSTRAINT pkey_qgep_vl_reach_relining_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_relining_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6455,6455,'full_reach','ganze_Haltung','troncon_entier', 'zzz_ganze_Haltung', 'tronson_intreg', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6456,6456,'partial','partiell','partiellement', 'zzz_partiell', 'partial', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_relining_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6457,6457,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_reach ADD CONSTRAINT rel_reach_reach_point_from FOREIGN KEY (fk_reach_point_from) REFERENCES qgep.od_reach_point(obj_id) ON UPDATE CASCADE ON DELETE cascade;
ALTER TABLE qgep.od_reach ADD COLUMN fk_reach_point_to varchar (16);
ALTER TABLE qgep.od_reach ADD CONSTRAINT rel_reach_reach_point_to FOREIGN KEY (fk_reach_point_to) REFERENCES qgep.od_reach_point(obj_id) ON UPDATE CASCADE ON DELETE cascade;
...
ALTER TABLE qgep.vl_mechanical_pretreatment_kind ADD CONSTRAINT pkey_qgep_vl_mechanical_pretreatment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3317,3317,'filter_bag','Filtersack','percolateur', 'zzz_Filtersack', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3319,3319,'artificial_adsorber','KuenstlicherAdsorber','adsorbeur_artificiel', 'zzz_KuenstlicherAdsorber', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3318,3318,'swale_french_drain_system','MuldenRigolenSystem','systeme_cuvettes_rigoles', 'zzz_MuldenRigolenSystem', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3320,3320,'slurry_collector','Schlammsammler','collecteur_de_boue', 'pozzetto_decantazione', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3321,3321,'floating_matter_separator','Schwimmstoffabscheider','separateur_materiaux_flottants', 'separatore_materiali_galleggianti', 'separator_materie_flotanta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_mechanical_pretreatment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3322,3322,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_mechanical_pretreatment ADD CONSTRAINT rel_mechanical_pretreatment_infiltration_installation FOREIGN KEY (fk_infiltration_installation) REFERENCES qgep.od_infiltration_installation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_mechanical_pretreatment ADD COLUMN fk_wastewater_structure varchar (16);
ALTER TABLE qgep.od_mechanical_pretreatment ADD CONSTRAINT rel_mechanical_pretreatment_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON UPDATE CASCADE ON DELETE set null;
...
ALTER TABLE qgep.vl_retention_body_kind ADD CONSTRAINT pkey_qgep_vl_retention_body_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2992,2992,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (346,346,'retention_in_habitat','Biotop','retention_dans_bassins_et_depressions', 'zzz_Biotop', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (345,345,'roof_retention','Dachretention','retention_sur_toits', 'zzz_Dachretention', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (348,348,'parking_lot','Parkplatz','retention_sur_routes_et_places', 'zzz_Parkplatz', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (347,347,'accumulation_channel','Staukanal','retention_dans_canalisations_stockage', 'zzz_Staukanal', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_retention_body_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3031,3031,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_retention_body ADD CONSTRAINT rel_retention_body_infiltration_installation FOREIGN KEY (fk_infiltration_installation) REFERENCES qgep.od_infiltration_installation(obj_id) ON UPDATE CASCADE ON DELETE cascade;
CREATE TABLE qgep.vl_overflow_char_kind_overflow_characteristic () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_overflow_char_kind_overflow_characteristic ADD CONSTRAINT pkey_qgep_vl_overflow_char_kind_overflow_characteristic_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_char_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6220,6220,'hq','HQ','HQ', 'HQ', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_char_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6221,6221,'qq','QQ','QQ', 'QQ', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_char_kind_overflow_characteristic (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6228,6228,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_overflow_char ADD CONSTRAINT fkey_vl_overflow_char_kind_overflow_characteristic FOREIGN KEY (kind_overflow_characteristic)
 REFERENCES qgep.vl_overflow_char_kind_overflow_characteristic (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_overflow_char_overflow_characteristic_digital () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_overflow_char_overflow_characteristic_digital ADD CONSTRAINT pkey_qgep_vl_overflow_char_overflow_characteristic_digital_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_char_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6223,6223,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_char_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6224,6224,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_char_overflow_characteristic_digital (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6225,6225,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_structure_part_renovation_demand ADD CONSTRAINT pkey_qgep_vl_structure_part_renovation_demand_code PRIMARY KEY (code);
 ...
 INSERT INTO qgep.vl_structure_part_renovation_demand (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (137,137,'necessary','notwendig','necessaire', 'zzz_notwendig', 'necesare', 'N', 'N', 'N', '', '', 'true');
 INSERT INTO qgep.vl_structure_part_renovation_demand (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5358,5358,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.od_structure_part ADD CONSTRAINT rel_structure_part_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON UPDATE CASCADE ON DELETE cascade;
ALTER TABLE qgep.od_dryweather_downspout ADD CONSTRAINT oorel_od_dryweather_downspout_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_access_aid ADD CONSTRAINT oorel_od_access_aid_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_access_aid_kind ADD CONSTRAINT pkey_qgep_vl_access_aid_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5357,5357,'other','andere','autre', 'altro', 'altul', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (243,243,'pressurized_door','Drucktuere','porte_etanche', 'zzz_Drucktuere', 'usa_presurizata', 'PD', 'D', 'PE', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (92,92,'none','keine','aucun_equipement_d_acces', 'nessuno', 'inexistent', '', 'K', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (240,240,'ladder','Leiter','echelle', 'zzz_Leiter', 'scara', '', 'L', 'EC', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (241,241,'step_iron','Steigeisen','echelons', 'zzz_Steigeisen', 'esaloane', '', 'S', 'ECO', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3473,3473,'staircase','Treppe','escalier', 'zzz_Treppe', 'structura_scari', '', 'R', 'ES', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (91,91,'footstep_niches','Trittnischen','marchepieds', 'zzz_Trittnischen', 'trepte', '', 'N', 'N', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3230,3230,'door','Tuere','porte', 'porta', 'usa', '', 'T', 'P', '', '', 'true');
 INSERT INTO qgep.vl_access_aid_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3048,3048,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_dryweather_flume ADD CONSTRAINT oorel_od_dryweather_flume_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_dryweather_flume_material ADD CONSTRAINT pkey_qgep_vl_dryweather_flume_material_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3221,3221,'other','andere','autres', 'altri', 'alta', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (354,354,'combined','kombiniert','combine', 'zzz_kombiniert', 'combinata', '', 'KOM', 'COM', '', '', 'true');
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5356,5356,'plastic','Kunststoff','matiere_synthetique', 'zzz_Kunststoff', 'materie_sintetica', '', 'KU', 'MS', '', '', 'true');
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (238,238,'stoneware','Steinzeug','gres', 'gres', 'gresie', '', 'STZ', 'GR', '', '', 'true');
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3017,3017,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_dryweather_flume_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (237,237,'cement_mortar','Zementmoertel','mortier_de_ciment', 'zzz_Zementmoertel', 'mortar_ciment', '', 'ZM', 'MC', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_cover ADD CONSTRAINT oorel_od_cover_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_cover_cover_shape ADD CONSTRAINT pkey_qgep_vl_cover_cover_shape_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_cover_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5353,5353,'other','andere','autre', 'altro', 'altul', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_cover_cover_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3499,3499,'rectangular','eckig','anguleux', 'zzz_eckig', 'dreptunghic', 'R', 'E', 'AX', '', '', 'true');
 INSERT INTO qgep.vl_cover_cover_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3498,3498,'round','rund','rond', 'zzz_rund', 'rotund', '', 'R', 'R', '', '', 'true');
 INSERT INTO qgep.vl_cover_cover_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5354,5354,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_cover_fastening ADD CONSTRAINT pkey_qgep_vl_cover_fastening_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_fastening (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5350,5350,'not_bolted','nicht_verschraubt','non_vissee', 'zzz_nicht_verschraubt', 'neinsurubata', '', 'NVS', 'NVS', '', '', 'true');
 INSERT INTO qgep.vl_cover_fastening (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5351,5351,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_cover_fastening (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5352,5352,'bolted','verschraubt','vissee', 'zzz_verschraubt', 'insurubata', '', 'VS', 'VS', '', '', 'true');
...
ALTER TABLE qgep.vl_cover_material ADD CONSTRAINT pkey_qgep_vl_cover_material_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5355,5355,'other','andere','autre', 'altro', 'altul', 'O', 'A', 'AU', '', '', 'true');
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (234,234,'concrete','Beton','beton', 'zzz_Beton', 'beton', 'C', 'B', 'B', '', '', 'true');
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (233,233,'cast_iron','Guss','fonte', 'zzz_Guss', 'fonta', '', 'G', 'F', '', '', 'true');
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5547,5547,'cast_iron_with_pavement_filling','Guss_mit_Belagsfuellung','fonte_avec_remplissage_en_robe', 'zzz_Guss_mit_Belagsfuellung', 'fonta_cu_umplutura', 'CIP', 'GBL', 'FRE', '', '', 'true');
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (235,235,'cast_iron_with_concrete_filling','Guss_mit_Betonfuellung','fonte_avec_remplissage_en_beton', 'zzz_Guss_mit_Betonfuellung', 'fonta_cu_umplutura_beton', '', 'GBT', 'FRB', '', '', 'true');
 INSERT INTO qgep.vl_cover_material (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3015,3015,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_cover_positional_accuracy ADD CONSTRAINT pkey_qgep_vl_cover_positional_accuracy_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_positional_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3243,3243,'more_than_50cm','groesser_50cm','plusque_50cm', 'maggiore_50cm', 'mai_mare_50cm', '', 'G50', 'S50', '', '', 'true');
 INSERT INTO qgep.vl_cover_positional_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3241,3241,'plusminus_10cm','plusminus_10cm','plus_moins_10cm', 'piu_meno_10cm', 'plus_minus_10cm', '', 'P10', 'P10', '', '', 'true');
 INSERT INTO qgep.vl_cover_positional_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3236,3236,'plusminus_3cm','plusminus_3cm','plus_moins_3cm', 'piu_meno_3cm', 'plus_minus_3cm', '', 'P03', 'P03', '', '', 'true');
 INSERT INTO qgep.vl_cover_positional_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3242,3242,'plusminus_50cm','plusminus_50cm','plus_moins_50cm', 'piu_meno_50cm', 'plus_minus_50cm', '', 'P50', 'P50', '', '', 'true');
 INSERT INTO qgep.vl_cover_positional_accuracy (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5349,5349,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.vl_cover_sludge_bucket ADD CONSTRAINT pkey_qgep_vl_cover_sludge_bucket_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_sludge_bucket (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (423,423,'inexistent','nicht_vorhanden','inexistant', 'zzz_nicht_vorhanden', 'inexistent', '', 'NV', 'IE', '', '', 'true');
 INSERT INTO qgep.vl_cover_sludge_bucket (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3066,3066,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 INSERT INTO qgep.vl_cover_sludge_bucket (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (422,422,'existent','vorhanden','existant', 'zzz_vorhanden', 'existent', '', 'V', 'E', '', '', 'true');
...
ALTER TABLE qgep.vl_cover_venting ADD CONSTRAINT pkey_qgep_vl_cover_venting_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_cover_venting (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (229,229,'vented','entlueftet','aere', 'zzz_entlueftet', 'cu_aerisire', '', 'EL', 'AE', '', '', 'true');
 INSERT INTO qgep.vl_cover_venting (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (230,230,'not_vented','nicht_entlueftet','non_aere', 'zzz_nicht_entlueftet', 'fara_aerisire', '', 'NEL', 'NAE', '', '', 'true');
 INSERT INTO qgep.vl_cover_venting (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5348,5348,'unknown','unbekannt','inconnue', 'sconosciuto', 'necunoscut', '', 'U', 'I', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_electric_equipment ADD CONSTRAINT oorel_od_electric_equipment_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_electric_equipment_kind ADD CONSTRAINT pkey_qgep_vl_electric_equipment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2980,2980,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (376,376,'illumination','Beleuchtung','eclairage', 'zzz_Beleuchtung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3255,3255,'remote_control_system','Fernwirkanlage','installation_de_telecommande', 'zzz_Fernwirkanlage', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (378,378,'radio_unit','Funk','radio', 'zzz_Funk', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (377,377,'phone','Telephon','telephone', 'telefono', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electric_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3038,3038,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_electromechanical_equipment ADD CONSTRAINT oorel_od_electromechanical_equipment_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_electromechanical_equipment_kind ADD CONSTRAINT pkey_qgep_vl_electromechanical_equipment_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_electromechanical_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2981,2981,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electromechanical_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (380,380,'leakage_water_pump','Leckwasserpumpe','pompe_d_epuisement', 'zzz_Leckwasserpumpe', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electromechanical_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (337,337,'air_dehumidifier','Luftentfeuchter','deshumidificateur', 'zzz_Luftentfeuchter', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electromechanical_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (381,381,'scraper_installation','Raeumeinrichtung','dispositif_de_curage', 'zzz_Raeumeinrichtung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_electromechanical_equipment_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3072,3072,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_benching ADD CONSTRAINT oorel_od_benching_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_benching_kind ADD CONSTRAINT pkey_qgep_vl_benching_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_benching_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5319,5319,'other','andere','autre', 'altro', 'alta', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_benching_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (94,94,'double_sided','beidseitig','double', 'zzz_beidseitig', 'dubla', 'DS', 'BB', 'D', '', '', 'true');
 INSERT INTO qgep.vl_benching_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (93,93,'one_sided','einseitig','simple', 'zzz_einseitig', 'simpla', 'OS', 'EB', 'S', '', '', 'true');
 INSERT INTO qgep.vl_benching_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3231,3231,'none','kein','aucun', 'nessuno', 'niciun', '', 'KB', 'AN', '', '', 'true');
 INSERT INTO qgep.vl_benching_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3033,3033,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscuta', '', 'U', 'I', '', '', 'true');
...
ALTER TABLE qgep.od_connection_object ADD CONSTRAINT rel_connection_object_wastewater_networkelement FOREIGN KEY (fk_wastewater_networkelement) REFERENCES qgep.od_wastewater_networkelement(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_connection_object ADD COLUMN fk_owner varchar (16);
ALTER TABLE qgep.od_connection_object ADD CONSTRAINT rel_connection_object_owner FOREIGN KEY (fk_owner) REFERENCES qgep.od_organisation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_connection_object ADD COLUMN fk_operator varchar (16);
ALTER TABLE qgep.od_connection_object ADD CONSTRAINT rel_connection_object_operator FOREIGN KEY (fk_operator) REFERENCES qgep.od_organisation(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_building ADD CONSTRAINT oorel_od_building_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_reservoir ADD CONSTRAINT oorel_od_reservoir_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_individual_surface ADD CONSTRAINT oorel_od_individual_surface_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_individual_surface_function ADD CONSTRAINT pkey_qgep_vl_individual_surface_function_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2979,2979,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3466,3466,'railway_site','Bahnanlagen','installation_ferroviaire', 'zzz_Bahnanlagen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3461,3461,'roof_industrial_or_commercial_building','DachflaecheIndustrieundGewerbebetriebe','surface_toits_bat_industriels_artisanaux', 'zzz_DachflaecheIndustrieundGewerbebetriebe', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3460,3460,'roof_residential_or_office_building','DachflaecheWohnundBuerogebaeude','surface_toits_imm_habitation_administratifs', 'zzz_DachflaecheWohnundBuerogebaeude', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3464,3464,'access_or_collecting_road','Erschliessungs_Sammelstrassen','routes_de_desserte_et_collectives', 'zzz_Erschliessungs_Sammelstrassen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3467,3467,'parking_lot','Parkplaetze','parkings', 'zzz_Parkplaetze', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3462,3462,'transfer_site_or_stockyard','UmschlagundLagerplaetze','places_transbordement_entreposage', 'zzz_UmschlagundLagerplaetze', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3029,3029,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3465,3465,'connecting_or_principal_or_major_road','Verbindungs_Hauptverkehrs_Hochleistungsstrassen','routes_de_raccordement_principales_grand_trafic', '', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3463,3463,'forecourt_and_access_road','VorplaetzeZufahrten','places_devant_entree_acces', 'zzz_VorplaetzeZufahrten', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_individual_surface_pavement ADD CONSTRAINT pkey_qgep_vl_individual_surface_pavement_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2978,2978,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2031,2031,'paved','befestigt','impermeabilise', 'zzz_befestigt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2032,2032,'forested','bestockt','boise', 'zzz_bestockt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2033,2033,'soil_covered','humusiert','couverture_vegetale', 'zzz_humusiert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3030,3030,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_individual_surface_pavement (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2034,2034,'barren','vegetationslos','sans_vegetation', 'zzz_vegetationslos', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_fountain ADD CONSTRAINT oorel_od_fountain_connection_object FOREIGN KEY (obj_id) REFERENCES qgep.od_connection_object(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_catchment_area_direct_discharge_current ADD CONSTRAINT pkey_qgep_vl_catchment_area_direct_discharge_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_direct_discharge_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5457,5457,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_direct_discharge_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5458,5458,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_direct_discharge_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5463,5463,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_direct_discharge_planned ADD CONSTRAINT pkey_qgep_vl_catchment_area_direct_discharge_planned_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_direct_discharge_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5459,5459,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_direct_discharge_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5460,5460,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_direct_discharge_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5464,5464,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_drainage_system_current ADD CONSTRAINT pkey_qgep_vl_catchment_area_drainage_system_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5186,5186,'mixed_system','Mischsystem','systeme_unitaire', 'sistema_misto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5188,5188,'modified_system','ModifiziertesSystem','systeme_modifie', 'sistema_modificato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5185,5185,'not_connected','nicht_angeschlossen','non_raccorde', 'non_collegato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5537,5537,'not_drained','nicht_entwaessert','non_evacue', 'non_evacuato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5187,5187,'separated_system','Trennsystem','systeme_separatif', 'sistema_separato', 'rrr_Trennsystem', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5189,5189,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_drainage_system_planned ADD CONSTRAINT pkey_qgep_vl_catchment_area_drainage_system_planned_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5191,5191,'mixed_system','Mischsystem','systeme_unitaire', 'sistema_misto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5193,5193,'modified_system','ModifiziertesSystem','systeme_modifie', 'sistema_modificato', 'rrr_ModifiziertesSystem', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5194,5194,'not_connected','nicht_angeschlossen','non_raccorde', 'non_collegato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5536,5536,'not_drained','nicht_entwaessert','non_evacue', 'non_evacuato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5192,5192,'separated_system','Trennsystem','systeme_separatif', 'sistema_separato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_drainage_system_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5195,5195,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_infiltration_current ADD CONSTRAINT pkey_qgep_vl_catchment_area_infiltration_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_infiltration_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5452,5452,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_infiltration_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5453,5453,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_infiltration_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5165,5165,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_infiltration_planned ADD CONSTRAINT pkey_qgep_vl_catchment_area_infiltration_planned_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_infiltration_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5461,5461,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_infiltration_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5462,5462,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_infiltration_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5170,5170,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_retention_current ADD CONSTRAINT pkey_qgep_vl_catchment_area_retention_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_retention_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5467,5467,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_retention_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5468,5468,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_retention_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5469,5469,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_retention_planned ADD CONSTRAINT pkey_qgep_vl_catchment_area_retention_planned_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_retention_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5470,5470,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_retention_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5471,5471,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_retention_planned (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5472,5472,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_catchment_area ADD CONSTRAINT rel_catchment_area_wastewater_networkelement_rw_current FOREIGN KEY (fk_wastewater_networkelement_rw_current) REFERENCES qgep.od_wastewater_networkelement(obj_id) ON UPDATE CASCADE ON DELETE set null;
ALTER TABLE qgep.od_catchment_area ADD COLUMN fk_wastewater_networkelement_rw_planned varchar (16);
ALTER TABLE qgep.od_catchment_area ADD CONSTRAINT rel_catchment_area_wastewater_networkelement_rw_planned FOREIGN KEY (fk_wastewater_networkelement_rw_planned) REFERENCES qgep.od_wastewater_networkelement(obj_id) ON UPDATE CASCADE ON DELETE set null;
...
ALTER TABLE qgep.vl_measuring_point_damming_device ADD CONSTRAINT pkey_qgep_vl_measuring_point_damming_device_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_measuring_point_damming_device (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5720,5720,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_damming_device (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5721,5721,'none','keiner','aucun', 'nessuno', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_damming_device (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5722,5722,'overflow_weir','Ueberfallwehr','lame_deversante', 'sfioratore', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_damming_device (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5724,5724,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_damming_device (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5723,5723,'venturi_necking','Venturieinschnuerung','etranglement_venturi', 'zzz_Venturieinschnuerung', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_measuring_point_purpose ADD CONSTRAINT pkey_qgep_vl_measuring_point_purpose_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_measuring_point_purpose (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4595,4595,'both','beides','les_deux', 'entrambi', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_purpose (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4593,4593,'cost_sharing','Kostenverteilung','repartition_des_couts', 'ripartizione_costi', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_purpose (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4594,4594,'technical_purpose','technischer_Zweck','but_technique', 'scopo_tecnico', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_point_purpose (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (4592,4592,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_measuring_device_kind ADD CONSTRAINT pkey_qgep_vl_measuring_device_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5702,5702,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5703,5703,'static_sounding_stick','Drucksonde','sonde_de_pression', 'sensore_pressione', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5704,5704,'bubbler_system','Lufteinperlung','injection_bulles_d_air', 'insufflazione', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5705,5705,'EMF_partly_filled','MID_teilgefuellt','MID_partiellement_rempli', 'DEM_riempimento_parziale', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5706,5706,'EMF_filled','MID_vollgefuellt','MID_rempli', 'DEM_riempimento_pieno', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5707,5707,'radar','Radar','radar', 'radar', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5708,5708,'float','Schwimmer','flotteur', 'galleggiante', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6322,6322,'ultrasound','Ultraschall','ultrason', 'zzz_Ultraschall', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measuring_device_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5709,5709,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_measurement_series_kind ADD CONSTRAINT pkey_qgep_vl_measurement_series_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_measurement_series_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3217,3217,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_series_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2646,2646,'continuous','kontinuierlich','continu', 'zzz_kontinuierlich', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_series_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2647,2647,'rain_weather','Regenwetter','temps_de_pluie', 'tempo_pioggia', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_series_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3053,3053,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_measurement_result_measurement_type ADD CONSTRAINT pkey_qgep_vl_measurement_result_measurement_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_measurement_result_measurement_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5732,5732,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_result_measurement_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5733,5733,'flow','Durchfluss','debit', 'zzz_Durchfluss', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_result_measurement_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5734,5734,'level','Niveau','niveau', 'livello', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_measurement_result_measurement_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5735,5735,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_actuation ADD CONSTRAINT pkey_qgep_vl_overflow_actuation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3667,3667,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (301,301,'gaz_engine','Benzinmotor','moteur_a_essence', 'zzz_Benzinmotor', 'motor_benzina', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (302,302,'diesel_engine','Dieselmotor','moteur_diesel', 'zzz_Dieselmotor', 'motor_diesel', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (303,303,'electric_engine','Elektromotor','moteur_electrique', 'zzz_Elektromotor', 'motor_electric', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (433,433,'hydraulic','hydraulisch','hydraulique', 'zzz_hydraulisch', 'hidraulic', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (300,300,'none','keiner','aucun', 'nessuno', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (305,305,'manual','manuell','manuel', 'zzz_manuell', 'manual', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (304,304,'pneumatic','pneumatisch','pneumatique', 'zzz_pneumatisch', 'pneumatic', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3005,3005,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_adjustability ADD CONSTRAINT pkey_qgep_vl_overflow_adjustability_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (355,355,'fixed','fest','fixe', 'zzz_fest', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3021,3021,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (356,356,'adjustable','verstellbar','reglable', 'zzz_verstellbar', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_control ADD CONSTRAINT pkey_qgep_vl_overflow_control_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (308,308,'closed_loop_control','geregelt','avec_regulation', 'zzz_geregelt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (307,307,'open_loop_control','gesteuert','avec_commande', 'zzz_gesteuert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (306,306,'none','keine','aucun', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3028,3028,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_function ADD CONSTRAINT pkey_qgep_vl_overflow_function_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3228,3228,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3384,3384,'internal','intern','interne', 'zzz_intern', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (217,217,'emergency_overflow','Notentlastung','deversoir_de_secours', 'zzz_Notentlastung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5544,5544,'stormwater_overflow','Regenueberlauf','deversoir_d_orage', 'scaricatore_piena', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5546,5546,'internal_overflow','Trennueberlauf','deversoir_interne', 'zzz_Trennueberlauf', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_function (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3010,3010,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_overflow_signal_transmission ADD CONSTRAINT pkey_qgep_vl_overflow_signal_transmission_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_overflow_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2694,2694,'receiving','empfangen','recevoir', 'zzz_empfangen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2693,2693,'sending','senden','emettre', 'zzz_senden', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2695,2695,'sending_receiving','senden_empfangen','emettre_recevoir', 'zzz_senden_empfangen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_overflow_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3056,3056,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_throttle_shut_off_unit_actuation ADD CONSTRAINT pkey_qgep_vl_throttle_shut_off_unit_actuation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3213,3213,'other','andere','autres', 'altri', 'altul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3154,3154,'gaz_engine','Benzinmotor','moteur_a_essence', 'zzz_Benzinmotor', 'motor_benzina', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3155,3155,'diesel_engine','Dieselmotor','moteur_diesel', 'zzz_Dieselmotor', 'motor_diesel', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3156,3156,'electric_engine','Elektromotor','moteur_electrique', 'zzz_Elektromotor', 'motor_electric', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3152,3152,'hydraulic','hydraulisch','hydraulique', 'zzz_hydraulisch', 'hidraulic', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3153,3153,'none','keiner','aucun', 'nessuno', 'niciunul', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3157,3157,'manual','manuell','manuel', 'zzz_manuell', 'manual', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3158,3158,'pneumatic','pneumatisch','pneumatique', 'zzz_pneumatisch', 'pneumatic', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3151,3151,'unknown','unbekannt','inconnu', 'sconosciuto', 'necunoscut', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_throttle_shut_off_unit_adjustability ADD CONSTRAINT pkey_qgep_vl_throttle_shut_off_unit_adjustability_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_throttle_shut_off_unit_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3159,3159,'fixed','fest','fixe', 'zzz_fest', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3161,3161,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_adjustability (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3160,3160,'adjustable','verstellbar','reglable', 'zzz_verstellbar', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_throttle_shut_off_unit_control ADD CONSTRAINT pkey_qgep_vl_throttle_shut_off_unit_control_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_throttle_shut_off_unit_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3162,3162,'closed_loop_control','geregelt','avec_regulation', 'zzz_geregelt', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3163,3163,'open_loop_control','gesteuert','avec_commande', 'zzz_gesteuert', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3165,3165,'none','keine','aucun', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_control (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3164,3164,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_throttle_shut_off_unit_kind ADD CONSTRAINT pkey_qgep_vl_throttle_shut_off_unit_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2973,2973,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2746,2746,'orifice','Blende','diaphragme_ou_seuil', 'zzz_Blende', 'diafragma_sau_prag', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2691,2691,'stop_log','Dammbalken','batardeau', 'zzz_Dammbalken', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (252,252,'throttle_flap','Drosselklappe','clapet_de_limitation', 'zzz_Drosselklappe', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (135,135,'throttle_valve','Drosselschieber','vanne_de_limitation', 'zzz_Drosselschieber', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6490,6490,'throttle_section','Drosselstrecke','conduite_d_etranglement', 'zzz_Drosselstrecke', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6491,6491,'leapingweir','Leapingwehr','leaping_weir', 'zzz_Leapingwehr', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6492,6492,'pomp','Pumpe','pompe', 'zzz_Pumpe', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2690,2690,'backflow_flap','Rueckstauklappe','clapet_de_non_retour_a_battant', 'zzz_Rueckstauklappe', 'clapeta _antirefulare', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2688,2688,'valve','Schieber','vanne', 'zzz_Schieber', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (134,134,'tube_throttle','Schlauchdrossel','limiteur_a_membrane', 'zzz_Schlauchdrossel', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2689,2689,'sliding_valve','Schuetze','vanne_ecluse', 'zzz_Schuetze', 'vana_cu?it', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5755,5755,'gate_shield','Stauschild','plaque_de_retenue', 'paratoia_cilindrica', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3046,3046,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (133,133,'whirl_throttle','Wirbeldrossel','limiteur_a_vortex', 'zzz_Wirbeldrossel', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_throttle_shut_off_unit_signal_transmission ADD CONSTRAINT pkey_qgep_vl_throttle_shut_off_unit_signal_transmission_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_throttle_shut_off_unit_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3171,3171,'receiving','empfangen','recevoir', 'zzz_empfangen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3172,3172,'sending','senden','emettre', 'zzz_senden', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3169,3169,'sending_receiving','senden_empfangen','emettre_recevoir', 'zzz_senden_empfangen', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_throttle_shut_off_unit_signal_transmission (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3170,3170,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_prank_weir ADD CONSTRAINT oorel_od_prank_weir_overflow FOREIGN KEY (obj_id) REFERENCES qgep.od_overflow(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_prank_weir_weir_edge ADD CONSTRAINT pkey_qgep_vl_prank_weir_weir_edge_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_prank_weir_weir_edge (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2995,2995,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_prank_weir_weir_edge (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (351,351,'rectangular','rechteckig','angulaire', 'zzz_rechteckig', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_prank_weir_weir_edge (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (350,350,'round','rund','arrondie', 'zzz_rund', 'rotund', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_prank_weir_weir_edge (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (349,349,'sharp_edged','scharfkantig','arete_vive', 'zzz_scharfkantig', 'margini_ascutite', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_prank_weir_weir_edge (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3014,3014,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_prank_weir_weir_kind ADD CONSTRAINT pkey_qgep_vl_prank_weir_weir_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_prank_weir_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5772,5772,'raised','hochgezogen','a_seuil_sureleve', 'laterale_alto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_prank_weir_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5771,5771,'low','niedrig','a_seuil_abaisse', 'laterale_basso', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_pump ADD CONSTRAINT oorel_od_pump_overflow FOREIGN KEY (obj_id) REFERENCES qgep.od_overflow(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_pump_contruction_type ADD CONSTRAINT pkey_qgep_vl_pump_contruction_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2983,2983,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2662,2662,'compressed_air_system','Druckluftanlage','systeme_a_air_comprime', 'impianto_aria_compressa', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (314,314,'piston_pump','Kolbenpumpe','pompe_a_piston', 'pompa_pistoni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (309,309,'centrifugal_pump','Kreiselpumpe','pompe_centrifuge', 'pompa_centrifuga', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (310,310,'screw_pump','Schneckenpumpe','pompe_a_vis', 'pompa_a_vite', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3082,3082,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_contruction_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (2661,2661,'vacuum_system','Vakuumanlage','systeme_a_vide_d_air', 'impinato_a_vuoto_aria', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_pump_placement_of_actuation ADD CONSTRAINT pkey_qgep_vl_pump_placement_of_actuation_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_pump_placement_of_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (318,318,'wet','nass','immerge', 'zzz_nass', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_placement_of_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (311,311,'dry','trocken','non_submersible', 'zzz_trocken', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_placement_of_actuation (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3070,3070,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_pump_placement_of_pump ADD CONSTRAINT pkey_qgep_vl_pump_placement_of_pump_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_pump_placement_of_pump (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (362,362,'horizontal','horizontal','horizontal', 'zzz_horizontal', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_placement_of_pump (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3071,3071,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_placement_of_pump (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (363,363,'vertical','vertikal','vertical', 'zzz_vertikal', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_pump_usage_current ADD CONSTRAINT pkey_qgep_vl_pump_usage_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6325,6325,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6202,6202,'creek_water','Bachwasser','eaux_cours_d_eau', 'acqua_corso_acqua', 'ape_curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6203,6203,'discharged_combined_wastewater','entlastetes_Mischabwasser','eaux_mixtes_deversees', 'acque_miste_scaricate', 'ape_mixte_deversate', 'DCW', 'EW', 'EUD', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6204,6204,'industrial_wastewater','Industrieabwasser','eaux_industrielles', 'acque_industriali', 'ape_industriale', '', 'CW', 'EUC', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6201,6201,'combined_wastewater','Mischabwasser','eaux_mixtes', 'acque_miste', 'ape_mixte', '', 'MW', 'EUM', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6205,6205,'rain_wastewater','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'apa_meteorica', '', 'RW', 'EUP', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6200,6200,'clean_wastewater','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EUR', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6206,6206,'wastewater','Schmutzabwasser','eaux_usees', 'acque_luride', '', '', 'SW', 'EU', '', '', 'true');
 INSERT INTO qgep.vl_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6326,6326,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_leapingweir ADD CONSTRAINT oorel_od_leapingweir_overflow FOREIGN KEY (obj_id) REFERENCES qgep.od_overflow(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_leapingweir_opening_shape ADD CONSTRAINT pkey_qgep_vl_leapingweir_opening_shape_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_leapingweir_opening_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3581,3581,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_leapingweir_opening_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3582,3582,'circle','Kreis','circulaire', 'zzz_Kreis', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_leapingweir_opening_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3585,3585,'parable','Parabel','parabolique', 'zzz_Parabel', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_leapingweir_opening_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3583,3583,'rectangular','Rechteck','rectangulaire', 'zzz_Rechteck', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_leapingweir_opening_shape (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (3584,3584,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_hydraulic_char_data_is_overflowing () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_hydraulic_char_data_is_overflowing ADD CONSTRAINT pkey_qgep_vl_hydraulic_char_data_is_overflowing_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_char_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5774,5774,'yes','ja','oui', 'si', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5775,5775,'no','nein','non', 'no', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_is_overflowing (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5778,5778,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT fkey_vl_hydraulic_char_data_is_overflowing FOREIGN KEY (is_overflowing)
 REFERENCES qgep.vl_hydraulic_char_data_is_overflowing (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_hydraulic_char_data_main_weir_kind () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_hydraulic_char_data_main_weir_kind ADD CONSTRAINT pkey_qgep_vl_hydraulic_char_data_main_weir_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_char_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6422,6422,'leapingweir','Leapingwehr','LEAPING_WEIR', 'zzz_Leapingwehr', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6420,6420,'spillway_raised','Streichwehr_hochgezogen','deversoir_lateral_a_seuil_sureleve', 'stramazzo_laterale_alto', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_main_weir_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6421,6421,'spillway_low','Streichwehr_niedrig','deversoir_lateral_a_seuil_abaisse', 'stamazzo_laterale_basso', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT fkey_vl_hydraulic_char_data_main_weir_kind FOREIGN KEY (main_weir_kind)
 REFERENCES qgep.vl_hydraulic_char_data_main_weir_kind (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_hydraulic_char_data_pump_characteristics () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_hydraulic_char_data_pump_characteristics ADD CONSTRAINT pkey_qgep_vl_hydraulic_char_data_pump_characteristics_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_char_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6374,6374,'alternating','alternierend','alterne', 'alternato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6375,6375,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6376,6376,'single','einzeln','individuel', 'singolo', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6377,6377,'parallel','parallel','parallele', 'parallelo', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_characteristics (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6378,6378,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT fkey_vl_hydraulic_char_data_pump_characteristics FOREIGN KEY (pump_characteristics)
 REFERENCES qgep.vl_hydraulic_char_data_pump_characteristics (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_hydraulic_char_data_pump_usage_current () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_hydraulic_char_data_pump_usage_current ADD CONSTRAINT pkey_qgep_vl_hydraulic_char_data_pump_usage_current_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6361,6361,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6362,6362,'creek_water','Bachwasser','eaux_cours_d_eau', 'acqua_corso_acqua', 'ape_curs_de_apa', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6363,6363,'discharged_combined_wastewater','entlastetes_Mischabwasser','eaux_mixtes_deversees', 'acque_miste_scaricate', 'ape_mixte_deversate', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6364,6364,'industrial_wastewater','Industrieabwasser','eaux_industrielles', 'acque_industriali', 'ape_industriale', '', 'CW', 'EUC', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6365,6365,'combined_wastewater','Mischabwasser','eaux_mixtes', 'acque_miste', 'ape_mixte', '', 'MW', 'EUM', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6366,6366,'rain_wastewater','Regenabwasser','eaux_pluviales', 'acque_meteoriche', 'apa_meteorica', '', 'RW', 'EUP', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6367,6367,'clean_wastewater','Reinabwasser','eaux_claires', 'acque_chiare', 'ape_conventional_curate', '', 'KW', 'EUR', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6368,6368,'wastewater','Schmutzabwasser','eaux_usees', 'acque_luride', '', '', 'SW', 'EU', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_pump_usage_current (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6369,6369,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT fkey_vl_hydraulic_char_data_pump_usage_current FOREIGN KEY (pump_usage_current)
 REFERENCES qgep.vl_hydraulic_char_data_pump_usage_current (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
CREATE TABLE qgep.vl_hydraulic_char_data_status () INHERITS (qgep.is_value_list_base);
ALTER TABLE qgep.vl_hydraulic_char_data_status ADD CONSTRAINT pkey_qgep_vl_hydraulic_char_data_status_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_hydraulic_char_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6371,6371,'planned','geplant','prevu', 'pianificato', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6372,6372,'current','Ist','actuel', 'attuale', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_hydraulic_char_data_status (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (6373,6373,'current_optimized','Ist_optimiert','actuel_opt', 'attuale_ottimizzato', '', '', '', '', '', '', 'true');
 ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT fkey_vl_hydraulic_char_data_status FOREIGN KEY (status)
 REFERENCES qgep.vl_hydraulic_char_data_status (code) MATCH SIMPLE 
 ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE qgep.vl_backflow_prevention_kind ADD CONSTRAINT pkey_qgep_vl_backflow_prevention_kind_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_backflow_prevention_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5760,5760,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_backflow_prevention_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5759,5759,'pump','Pumpe','pompe', 'pompa', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_backflow_prevention_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5757,5757,'backflow_flap','Rueckstauklappe','clapet_de_non_retour_a_battant', 'zzz_Rueckstauklappe', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_backflow_prevention_kind (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5758,5758,'gate_shield','Stauschild','plaque_de_retenue', 'paratoia_cilindrica', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_solids_retention ADD CONSTRAINT oorel_od_solids_retention_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_solids_retention_type ADD CONSTRAINT pkey_qgep_vl_solids_retention_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5664,5664,'other','andere','autres', 'altri', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5665,5665,'fine_screen','Feinrechen','grille_fine', 'griglia_fine', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5666,5666,'coarse_screen','Grobrechen','grille_grossiere', 'griglia_grossa', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5667,5667,'sieve','Sieb','tamis', 'filtro', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5668,5668,'scumboard','Tauchwand','paroi_plongeante', 'parete_sommersa', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_solids_retention_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5669,5669,'unknown','unbekannt','inconnu', 'sconosciuto', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_tank_cleaning ADD CONSTRAINT oorel_od_tank_cleaning_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_tank_cleaning_type ADD CONSTRAINT pkey_qgep_vl_tank_cleaning_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_tank_cleaning_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5621,5621,'airjet','Air_Jet','aeration_et_brassage', 'airjet', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_cleaning_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5620,5620,'other','andere','autre', 'altro', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_cleaning_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5622,5622,'none','keine','aucun', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_cleaning_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5623,5623,'surge_flushing','Schwallspuelung','rincage_en_cascade', 'zzz_Schwallspülung', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_cleaning_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5624,5624,'tipping_bucket','Spuelkippe','bac_de_rincage', 'zzz_Spuelkippe', '', '', '', '', '', '', 'true');
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_tank_emptying ADD CONSTRAINT oorel_od_tank_emptying_structure_part FOREIGN KEY (obj_id) REFERENCES qgep.od_structure_part(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE qgep.vl_tank_emptying_type ADD CONSTRAINT pkey_qgep_vl_tank_emptying_type_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_tank_emptying_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5626,5626,'other','andere','autre', 'altro', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_emptying_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5627,5627,'none','keine','aucun', 'nessuno', 'inexistent', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_emptying_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5628,5628,'pump','Pumpe','pompe', 'pompa', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_tank_emptying_type (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (5629,5629,'valve','Schieber','vanne', 'zzz_Schieber', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_param_ca_general ADD CONSTRAINT oorel_od_param_ca_general_surface_runoff_parameters FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_runoff_parameters(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE qgep.od_param_ca_mouse1 ADD CONSTRAINT oorel_od_param_ca_mouse1_surface_runoff_parameters FOREIGN KEY (obj_id) REFERENCES qgep.od_surface_runoff_parameters(obj_id) ON DELETE CASCADE ON UPDATE CASCADE;
...
COMMENT ON COLUMN qgep.od_wastewater_structure_text.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wastewater_structure_text ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_wastewater_structure_text.remark IS 'General remarks';
...
ALTER TABLE qgep.od_wastewater_structure_text ADD COLUMN textpos_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_reach_text.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
ALTER TABLE qgep.od_reach_text ADD COLUMN plantype  integer ;
COMMENT ON COLUMN qgep.od_reach_text.plantype IS '';
ALTER TABLE qgep.od_reach_text ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_reach_text.remark IS 'General remarks';
...
ALTER TABLE qgep.od_reach_text ADD COLUMN textpos_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_catchment_area_text.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_catchment_area_text ADD COLUMN remark  text ;
COMMENT ON COLUMN qgep.od_catchment_area_text.remark IS 'General remarks';
...
ALTER TABLE qgep.od_catchment_area_text ADD COLUMN textpos_geometry geometry('POINT', :SRID);
...
COMMENT ON COLUMN qgep.od_wastewater_structure_symbol.obj_id IS '[primary_key] INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
...
ALTER TABLE qgep.od_wastewater_structure_symbol ADD COLUMN symbolpos_geometry geometry('POINT', :SRID);
...
ALTER TABLE qgep.od_wastewater_structure_text ADD CONSTRAINT rel_wastewater_structure_text_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE qgep.od_reach_text ADD COLUMN fk_reach varchar (16);
ALTER TABLE qgep.od_reach_text ADD CONSTRAINT rel_reach_text_reach FOREIGN KEY (fk_reach) REFERENCES qgep.od_reach(obj_id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE qgep.od_catchment_area_text ADD COLUMN fk_catchment_area varchar (16);
ALTER TABLE qgep.od_catchment_area_text ADD CONSTRAINT rel_catchment_area_text_catchment_area FOREIGN KEY (fk_catchment_area) REFERENCES qgep.od_catchment_area(obj_id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE qgep.od_wastewater_structure_symbol ADD COLUMN fk_wastewater_structure varchar (16);
ALTER TABLE qgep.od_wastewater_structure_symbol ADD CONSTRAINT rel_wastewater_structure_symbol_wastewater_structure FOREIGN KEY (fk_wastewater_structure) REFERENCES qgep.od_wastewater_structure(obj_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE qgep.vl_wastewater_structure_text_plantype ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_text_plantype_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7844,7844,'pipeline_registry','Leitungskataster','cadastre_des_conduites_souterraines', 'catasto_delle_canalizzazioni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7846,7846,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7847,7847,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7848,7848,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7845,7845,'network_plan','Werkplan','plan_de_reseau', '', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_text_texthali ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_text_texthali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7850,7850,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7851,7851,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7852,7852,'2','2','2', '2', '2', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_text_textvali ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_text_textvali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7853,7853,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7854,7854,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7855,7855,'2','2','2', '2', '2', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7856,7856,'3','3','3', '3', '3', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7857,7857,'4','4','4', '4', '4', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_text_plantype ADD CONSTRAINT pkey_qgep_vl_reach_text_plantype_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7844,7844,'pipeline_registry','Leitungskataster','cadastre_des_conduites_souterraines', 'catasto_delle_canalizzazioni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7846,7846,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7847,7847,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7848,7848,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7845,7845,'network_plan','Werkplan','plan_de_reseau', '', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_text_texthali ADD CONSTRAINT pkey_qgep_vl_reach_text_texthali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7850,7850,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7851,7851,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7852,7852,'2','2','2', '2', '2', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_reach_text_textvali ADD CONSTRAINT pkey_qgep_vl_reach_text_textvali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_reach_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7853,7853,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7854,7854,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7855,7855,'2','2','2', '2', '2', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7856,7856,'3','3','3', '3', '3', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_reach_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7857,7857,'4','4','4', '4', '4', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_text_plantype ADD CONSTRAINT pkey_qgep_vl_catchment_area_text_plantype_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7844,7844,'pipeline_registry','Leitungskataster','cadastre_des_conduites_souterraines', 'catasto_delle_canalizzazioni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7846,7846,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7847,7847,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7848,7848,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7845,7845,'network_plan','Werkplan','plan_de_reseau', '', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_text_texthali ADD CONSTRAINT pkey_qgep_vl_catchment_area_text_texthali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7850,7850,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7851,7851,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_texthali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7852,7852,'2','2','2', '2', '2', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_catchment_area_text_textvali ADD CONSTRAINT pkey_qgep_vl_catchment_area_text_textvali_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_catchment_area_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7853,7853,'0','0','0', '0', '0', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7854,7854,'1','1','1', '1', '1', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7855,7855,'2','2','2', '2', '2', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7856,7856,'3','3','3', '3', '3', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_catchment_area_text_textvali (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7857,7857,'4','4','4', '4', '4', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.vl_wastewater_structure_symbol_plantype ADD CONSTRAINT pkey_qgep_vl_wastewater_structure_symbol_plantype_code PRIMARY KEY (code);
 INSERT INTO qgep.vl_wastewater_structure_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7874,7874,'pipeline_registry','Leitungskataster','cadastre_des_conduites_souterraines', 'catasto_delle_canalizzazioni', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7876,7876,'overviewmap.om10','Uebersichtsplan.UeP10','plan_d_ensemble.pe10', 'piano_di_insieme.pi10', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7877,7877,'overviewmap.om2','Uebersichtsplan.UeP2','plan_d_ensemble.pe2', 'piano_di_insieme.pi2', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7878,7878,'overviewmap.om5','Uebersichtsplan.UeP5','plan_d_ensemble.pe5', 'piano_di_insieme.pi5', '', '', '', '', '', '', 'true');
 INSERT INTO qgep.vl_wastewater_structure_symbol_plantype (code, vsacode, value_en, value_de, value_fr, value_it, value_ro, abbr_en, abbr_de, abbr_fr, abbr_it, abbr_ro, active) VALUES (7875,7875,'network_plan','Werkplan','plan_de_reseau', 'zzz_Werkplan', '', '', '', '', '', '', 'true');
...
ALTER TABLE qgep.od_overflow_char ADD CONSTRAINT rel_od_overflow_char_fk_dataowner FOREIGN KEY (fk_dataowner) REFERENCES qgep.od_organisation(obj_id);
ALTER TABLE qgep.od_overflow_char ADD CONSTRAINT rel_od_overflow_char_fk_dataprovider FOREIGN KEY (fk_provider) REFERENCES qgep.od_organisation(obj_id);
...
ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT rel_od_hydraulic_char_data_fk_dataowner FOREIGN KEY (fk_dataowner) REFERENCES qgep.od_organisation(obj_id);
ALTER TABLE qgep.od_hydraulic_char_data ADD CONSTRAINT rel_od_hydraulic_char_data_fk_dataprovider FOREIGN KEY (fk_provider) REFERENCES qgep.od_organisation(obj_id);
...
------ Indexes on identifiers
 ...
 CREATE UNIQUE INDEX in_od_overflow_char_identifier ON qgep.od_overflow_char USING btree (identifier ASC NULLS LAST, fk_dataowner ASC NULLS LAST);
 ...
 CREATE UNIQUE INDEX in_od_hydraulic_char_data_identifier ON qgep.od_hydraulic_char_data USING btree (identifier ASC NULLS LAST, fk_dataowner ASC NULLS LAST);
