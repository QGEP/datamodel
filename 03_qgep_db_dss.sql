...
ALTER TABLE qgep_od.organisation ADD COLUMN qgep_active boolean DEFAULT false;
...
ALTER TABLE qgep_od.reach ADD COLUMN progression_geometry geometry('COMPOUNDCURVEZ', :SRID) NOT NULL;
